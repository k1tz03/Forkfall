...
|---|---|---|---|---|
| **1990-1999** — l'ère des présidents bâtisseurs | francs ; droits télé qui triplent (1990) puis doublent (1997) ; premiers fonds lointains (1999) ; les clubs vivent des ventes et de la buvette | Télé-Stade rachète Capitale FC (1994) et invente le match du dimanche soir (1992) ; trois journaux papier, le fax, le Minitel du club | libéro, marquage individuel, quotas d'étrangers qui tombent (1997), le but en or (1999) ; les entraîneurs à cassette (Vaz) ; le pressing arrive du Nord (Vogler) | l'arrêt Vaneste (1993) libère les joueurs en fin de contrat ; premiers contrôles inopinés (1991) ; les stades passent tout-assis ; les Cobalts perdent une finale aux tirs au but (1990), gagnent le Continental à la maison (1996), ratent le Mondial (1998) |
| **2000-2009** — l'argent arrive | écus dès 2002 ; les droits passent à Médiacrash (2003) qui ne paie pas la deuxième échéance (2006) ; Almadis passe du maillot au rachat (Capitale FC, 2007) ; premières commissions à deux chiffres | le Flux (réseau social, 2008) ; Massenet devient consultant vedette ; La Gazette Rose passe au format tabloïd ; le podcast (2009) | le 4-2-3-1 partout, les préparateurs physiques, les données naissantes (« l'algorithme », 2008) | fair-play financier de l'Union Continentale (2009) ; la première section féminine professionnelle (Mirevaux, 2008) ; les présidents tweetent à 3 h du matin |
| **2010-2019** — l'ère des fonds | le prix des joueurs double tous les quatre ans ; multi-propriété (un club frère dans l'autre hémisphère) ; le naming des stades ; les agents plus riches que les présidents | la vidéo (2014) ; les chaînes de club ; Massenet directeur d'antenne ; le mème | pressing haut, gardien-libéro, « le modèle » qui note tout ; les jeunes vendus à 16 ans | la tentative de Ligue fermée (2019 : 60 heures) ; les 48 équipes au Mondial (votées en 2017) ; Gégé devient aussi un compte anonyme |
| **2020-2029** — le grand écart | le Mondial 2030 d'Al-Dorado se prépare : attribué en 2010, vingt ans à l'avance, contesté jusqu'en 2029 ; les clubs-franchises ; le premier transfert à un milliard (2028) | la diffusion en flux (Kick, 2021) ; les journaux papier ne vivent que par L'Écho ; Léa dirige Le Quotidien | l'arbitre algorithmique en test (2027) ; la Main de Dieu désactivée | la grève mondiale des joueurs (2026 : soixante-douze matchs par saison) ; le Mondial des amateurs ; la limite d'âge au Congrès (75 ans) |
...
| la Capitale | Capitale FC, « les Cravates » | le Grand Stade (1996) ; avant, le Vélodrome de la Porte | noir et blanc | Marsange (le Classique) | D1 · racheté par Télé-Stade (1994), puis par le fonds Almadis (2007) | on écrit « Capitale FC », jamais un nom de ville réelle ; le brainstorm dit « Paris Capitale FC » : lire « Capitale FC » |
...
| Mirevaux | AS Mirevaux, « les Mirettes » | stade de la Halle | rose et noir | Villefranche | D2 · première section féminine professionnelle du pays (2008) ; un des huit clubs du premier championnat professionnel (2016) | postulat « Championnat professionnel, année un » |
...
**L'étranger** (huit sélections, sept pays, jamais de pays réel) : la **Lusitanie** (Lusitano de Ribalvo, technique, mélancolique), la **Castellane** (Castel Montoya, le géant de Don Alvaro Montoya, « quatorze clubs, une table »), la **Vestrie** (SK Vestberg, le pressing et les casquettes, Vogler), la **Dalmarie** (Étoile de Dalmarie, gardiens légendaires, pays de Vukić), la **Brumelande** (Dunmore FC, la pluie, le ballon sorti de trois centimètres que la ligne n'a pas vu), l'émirat d'**Al-Dorado** (Al-Dorado FC, le championnat du désert, le Mondial d'hiver de 2030), le **Kambara** (Kambara Stars, sélection ambitieuse, pays d'origine de la famille Mbako, la sélection « de tes parents » du binational), la **Sylvanie** (Union Sylvane, le pays émergent du « coach du bout du monde », un ministre qui donne la compo). Les Cobalts jouent contre ces huit-là, contre les quatre nations ajoutées par le chapitre 14 — la **Boréalie** (« les Glaces », le stade du Fjord, une sélectionneuse dès 2018), la **Cormandie**, l'**Ostrélie** (« les Bois », le stade en bois qui a cent ans et tient debout, le dossier de candidature du ch. 15) et la **Vestrie du Sud** — et contre « des pays qu'on ne nomme pas » quand il faut un adversaire de plus. Douze nations, huit clubs étrangers nommés, aucun pays réel.

**Almadis n'est le fonds d'aucun État.** Le fonds d'Ilyas a « de l'argent de trois continents et le passeport d'aucun » : il rachète Capitale FC en 2007, il fait du naming, il préside la Ligue en 2028. L'émirat d'Al-Dorado est un **pays**, avec un club, un championnat et un Mondial d'hiver en 2030 ; les deux se croisent, ils ne se confondent pas, et aucune scène n'écrit « le fonds de l'émirat ».
...
| la Coupe d'été (1990) puis le Continental | championnat des nations tous les quatre ans (1992, 1996, 2000…) ; les Cobalts le gagnent chez eux en 1996, au Grand Stade neuf | tournoi du sélectionneur, un été sur deux |
| le Mondial | 1994, 1998, 2002 (gagné, à six mille kilomètres), 2006… ; 48 équipes à partir de 2022 (votées en 2015) ; 64 en 2046 ; un Mondial d'hiver à Al-Dorado (2030, attribué en 2010, vingt ans à l'avance) | le sommet du sélectionneur, l'attribution comme dossier de l'instance |
| la Ligue fermée | quatorze clubs, soixante heures en 2019 ; existe dans le monde persistant si six clubs tiennent | cartes de mépris : « Le derby n'existe plus. Le stade sonne creux. » |
...
- **La Fédération** (sigle FNF, on dit « la Fédération » ou « la Fédé » dans la bouche des joueurs) : présidée par Noé Berthomier de 1988 à 2008, puis par Vaubourg (2008-2016), puis par qui le joueur laisse gagner. Son **Congrès** réunit chaque juin les présidents de districts, de ligues et de clubs ; il élit tous les quatre ans (1992, 1996, 2000…). Sa **Commission de discipline** siège « salle 3 » ; on y est convoqué, on y attend, on y « examine ». Son **directeur technique national** (Brissac) tient les diplômes d'entraîneur : sans papier, pas de banc en D1, sauf dérogation de six mois. Son **secrétaire général** (Dauzat) sait tout et garde les procès-verbaux.
- **La Ligue professionnelle** : le syndicat des présidents de D1 et D2 ; répartit les droits télé (« les petits ou les gros ? ») ; Vaubourg la préside de 1998 à 2008 ; Malbec après lui.
...
- **L'Union Continentale** (UC) : cinquante fédérations, un Comité exécutif, les quatorze gros clubs qui menacent de fonder leur ligue ; siège dans une ville de lac qu'on ne nomme pas (« l'hôtel du Lac » est celui de ses Congrès et de ses perquisitions) ; le fair-play financier (2009).
...
- **le kop, le virage, la Tribune Nord** : la même chose, dans l'ordre de la bouche qui parle (Massenet dit kop, Gégé dit le virage, Josiane dit la Tribune Nord).
...
- **le chèque non daté** : l'indemnité qu'Vaubourg propose ; « je ne le date pas ».
...
- **le seau** : Anselmo Vaz s'assoit dessus au bord du terrain ; « regardez la cassette ».
...
4. **L'âge est celui de 1990** ; +1 par saison ; le portrait vieillit par paliers (gris à 45, lunettes à 55, canne à 75) — **et le palier se calcule, il ne s'écrit pas au hasard : palier = 1990 + (seuil − âge_1990)**. Un personnage a une **fenêtre d'activité** ; hors fenêtre il est `retraite` ou `parti`, et ne parle qu'au téléphone, à l'enterrement, ou comme Fantôme. **Une fenêtre d'activité se ferme à soixante-quinze ans.** Au-delà, ce n'est plus une fenêtre, c'est une blague, et une blague se déclare : la fiche écrit « fenêtre exceptionnelle assumée » et dit pourquoi (Josiane en poste à quatre-vingt-quatre ans, Montoya qui meurt à la table à quatre-vingt-onze, Roux et sa carte de délégué périmée, Ilyas qui a fait écrire que la Ligue n'a pas de limite d'âge). Les fenêtres non déclarées ont été fermées : Vialat en 2020, Vaz en 2010, Roux en 2002, Malbec en 2012, Aubert en 2022, Dauzat en 2024, Brissac en 2020, Vogler en 2027. Après lui, un « suivant » sous un autre nom (un nouveau prodige naît, une nouvelle secrétaire). Les chapitres 01 et 02 écrivent la fenêtre et le suivant.
...
9. **Le second rôle sans relation** (catégorie intermédiaire, ouverte après relecture) : entre le personnage à statut et la voix sans portrait, il y a le personnage qui tient un décor entier — le bus, la cantine, un stade, un postulat. Il reçoit **un portrait générique, un tic, une fenêtre**, et **aucune relation, aucun palier, aucune retrouvaille** ; il peut porter autant de cartes que son décor en demande. Y sont versés : **Norbert** (le chauffeur du bus), **Lulu** (la cantine), **Marinette** (le club-house), **le ministre de Sylvanie**, **Dragan Ilić** (capitaine de l'Union Sylvane), **Inès Marchal** (capitaine de Mirevaux, infirmière de nuit), **le fils de Corven** (Owen Corven), **la petite Josiane**, **Nino** (le capo d'après) et **le stagiaire de l'Écho**. Ils ne comptent pas dans les quarante-deux ; ils comptent dans le lint des locuteurs.
...
| `legruet` | Noé Berthomier, président de la Fédération (m, 63, instances) | « On verra ça après le Congrès. » | rester, nommer, être aimé des districts · il n'a jamais gagné une élection de plus de dix voix | « cher/chère {prenom} » / « madame/monsieur {nom} » / idem | entraîneur (le diplôme, la Commission), joueur (la sélection), sélectionneur (celui qui te nomme et te lâche), instance (ton prédécesseur, ton mentor ou ton adversaire ; vise l'Union Continentale, 2008-2016) ; retraité en 2016, meurt en 2020 |
| `nassir` | Cheikh Ilyas, fonds Almadis (m, 34, direction) | « Ce n'est pas un club, c'est un actif. » | rendement et image · il aimait le football avant d'en acheter | « {prenom} » / « coach » / « monsieur {nom} » | entraîneur (sponsor → naming → prêt → rachat), joueur (l'exil doré), président (l'actionnaire ou le propriétaire), DS (le budget illimité et ses conditions), instance (le comité du Mondial, 2010-2030) |
...
| `clow` | Dan Corven, le mentor (m, 61, terrain) | « Je ne dirais pas que j'étais un grand. Je dirais que j'étais devant. » | te voir réussir sans le dire · ses cinquante-neuf jours dans un grand club (Capitale FC, 1971 : renvoyé par lettre recommandée, un dimanche) ; il a arrêté quelque chose en 1979 et ne dit jamais quoi, il a toujours un verre d'eau plein devant lui | « petit » / « {prenom} » / « coach » | entraîneur (trois conseils, l'hôpital, le testament), joueur (le diplôme, « lundi, huit heures »), sélectionneur (le seul qui te dise que tu vas perdre), DS (il refuse de travailler avec ta lignée si tu as été ingrat) ; meurt entre 1995 et 2000 selon la carrière ; un buste au Panthéon ; son fils (« le fils de Corven ») est entraîneur à partir de 2005 |
...
| `loco` | Anselmo Vaz, entraîneur mystique (m, 45, terrain) | « Regardez la cassette. » | qu'on le comprenne · personne ne le comprend ; il s'assoit sur un seau parce que le banc est trop loin du terrain | « {prenom} » / « profesor » / (il ne parle pas aux gens qu'il n'aime pas) | entraîneur (le grand nom que le board veut pour janvier, le coach rival, l'espion dans le car de la presse), DS (le coach intouchable), joueur (le coach qui te fait courir 20 kilomètres), président (le postulat déblocable « Le coach-cassette ») |
| `klopf` | Vogler, entraîneur à casquette (m, 38, terrain) | « On court, on presse, on chante. » | le pressing comme une religion · les manches remontées, la montre au-dessus du poignet ; il a gagné trois finales et n'a jamais été aimé | « {prenom} » / « coach » / « collègue » | entraîneur (le rival qui gagne le derby, l'adjoint de Vaz un temps), sélectionneur (sélectionneur de la Vestrie 2004-2016), président (l'entraîneur que tout le monde veut), DS (il exige un latéral gauche) |
...
| `brissac` | Solange Brissac, directrice technique nationale (f, 49, selection) | « Les chiffres sont têtus, les joueurs aussi. » | la formation, les diplômes, le jeu · ancienne internationale d'une sélection féminine que personne ne filmait | « {prenom} » / « madame/monsieur {nom} » / idem | entraîneur (le diplôme, la dérogation, le stage de Corven), sélectionneur (l'attaquant naturalisé, la liste, le binational), instance (la commission technique, la sélection féminine et l'égalité des primes), joueur (« trop lent » dit aussi le chiffre) ; DTN 1988-2010, présidente de Mirevaux ensuite |
| `malbec` | Hubert Malbec, président du Racing de Valentienne (m, 54, direction) | « Entre présidents, on se comprend. » | la Ligue, puis la Fédération, sans passer par les districts · Vaubourg lui a pris un entraîneur et une élection | « cher {prenom} » / « {nom} » / « monsieur » | président (ton égal, ton allié, ton rival ; l'enveloppe côté adverse), entraîneur (le président qui te débauche), DS (le club qui offre 25 millions), instance (président de la Ligue 2008-2020, candidat à la Fédération contre toi), sélectionneur (il veut son joueur dans la liste) |
| `montoya` | Don Alvaro Montoya, président du Castel Montoya (m, 60, direction) | « Quatorze clubs. Une table. Vous êtes assis ou debout ? » | la Ligue fermée · son club a tout gagné et perd de l'argent | « ami » / « président » / « monsieur » | président (les 60 heures), instance (le bloc des quatorze contre l'Union), entraîneur (le Castel Montoya t'appelle à mi-saison), joueur (le transfert du siècle) ; meurt en 2021, son fils reprend « la table » |
...
| `rossard` | Aimé Rossard, sélectionneur des Cobalts (1986-1994), puis consultant de Télé-Stade (1995-2015) (m, 52, selection ; bande `direction` dès 1995) | « Moi, à votre place, je l'aurais fait. » | qu'on lui rende 1996 · la finale de 1990 perdue aux tirs au but, les larmes en direct, le limogeage par communiqué en 1994, et un successeur qui gagne avec des joueurs qu'il avait lancés | « cher collègue » / « le sélectionneur » / « lui » (il parle de toi à la troisième personne, en plateau) | sélectionneur (celui dont tu as pris la place, ou celui qui veut la tienne ; il te découpe en plateau et te dit en privé ce qu'il voit), joueur (celui qui t'appelle ou non, 1990-1994), entraîneur (le consultant du dimanche soir), instance (il se propose après le fiasco de 2011, à soixante-treize ans) ; meurt en 2022, devant une séance de tirs au but, avant le cinquième tireur |
...
Vingt-cinq nouveaux, dix-sept anciens : **quarante-deux personnages à statut** (Rossard, validé après relecture, est le quarante-deuxième). Les seconds rôles sans fiche (« un émissaire d'Almadis », « le stagiaire de l'Écho », « la petite Josiane », « le fils de Corven », « le fils de Montoya », « le fils de Dupuis », « ton cousin des îles », « Maître Vidal, ton avocat », « Tony, ton pote d'enfance ») sont des voix sans portrait : deux cartes chacun au plus par chapitre, jamais de relation.

### 2.4 bis Le statut `mort`

La spec § 2.5 ne liste que `club | vendu | staff | parti | retraite | rival`. Trente-trois des quarante-deux meurent pendant la fenêtre jouable, et quatorze scènes le lisent : le statut **`mort`** existe, il est ajouté à `characters.yaml`, et il obéit à trois règles.

1. **Un mort n'est plus locuteur**, sauf Fantôme (`co.fantome.*`, `co.retrouvailles.<id>_fantome`), sauf à son enterrement, et sauf par un **porte-parole nommé** qui parle à sa place : Bébert (pour Dédé), Marinette (pour Gérard), la petite Paulette (pour Paulette), Nino (pour Gégé), le fils de Corven (pour Corven), Josiane (pour à peu près tout le monde tant qu'elle est là).
2. **La relation est gelée** à sa dernière valeur, et lue au passé (« il vous aimait bien », jamais « il vous aime bien ») ; un `relation.<id> +1 (posthume)` reste écrivable : il ne change pas un visage, il change une phrase et l'Almanach.
3. **La trace `<id>_mort` est de portée monde** : elle est posée par la Nouvelle datée de l'année (ch. 20) ou par la scène d'enterrement, elle arme la ligne d'enterrement du ch. 31, et elle sert de **repli de condition** partout : une scène qui a besoin du mort écrit `chars.<id>.statut == 'mort' || (chars.<id>.statut == 'parti' && flag('<id>_mort'))`, ce qui la fait partir dans les deux hypothèses de moteur. Ce repli est obligatoire dans toute scène conditionnée par la mort.
...
| Joueur pro | Fardelli (agent), Vaubourg, Vukić (le coach) | Josiane, Rouvier | Bréhaut, Dembo, Vecchio, Mbako | Ilyas, Solvang, « ton cousin » | Léa, Vence, Massenet | Sabatier (le genou) |
| Entraîneur | Vaubourg, Malbec | Josiane, Vukić | Bréhaut, Vecchio, Mbako, Dembo, Rouvier | Ilyas, Fardelli, Gégé | Massenet, Léa | Corven (l'hôpital), Mbako |
| Directeur sportif | Vaubourg, Ilyas | Josiane, Barbier | Vogler ou Vaz (le coach), Bréhaut | Fardelli, Solvang, mère de Mbako | Massenet, Vence | Vialat (l'Inspecteur) |
...
| Président pro | Ilyas ou les actionnaires, Malbec | Josiane, Dauzat | Bréhaut (DS), Gégé, l'entraîneur (Vogler/Vaz/Vukić) | Montoya, Fardelli, Aubert (le stade) | Massenet, La Plume | Vialat |
| Sélectionneur | Berthomier, Brissac, Aubert (ministre) | Josiane (Fédération), Rouvier | Fauvel, Mbako, Vecchio, Dembo | Fardelli (l'agent du capitaine), Malbec | Vence, Massenet | le tournoi |
| Dirigeant d'instance | le Congrès : Roux, Malbec, Vaubourg ; Bambini | Josiane, Dauzat | Colline, Fauvel (syndicat), Brissac | Ilyas, Montoya, « un émissaire » | La Plume, Léa, Vence | Amsel (la procureure), l'élection |
...
| `six_mois` ★ | entraîneur | Six mois pour gagner | 2006 · D1 (club Almadis) | Un vestiaire de stars à trente, un propriétaire à quarante, un titre ou rien. | `stars / proprietaire / jeu` |
| `section_feminine` | entraîneur | Championnat professionnel, année un | 2016 · Mirevaux | Un budget de buvette, des joueuses qui ont un emploi, des médias qui arrivent. | `budget / emploi / medias` |
...
| `coach_intouchable` ★ | DS | Le coach intouchable | 2010 · D1 | Anselmo Vaz est vénéré par le président. Tu es le fusible entre deux monuments. | `loco / president / vestiaire` |
...
| `heritage_empoisonne` | instance (Fédération) | Héritage empoisonné | 2008 · la Fédération | Ton prédécesseur est parti à l’Union en laissant quatre tiroirs et trois clés. Le quatrième contient ce qu’il ne t’a pas dit. | `nettoyer / proteger / oublier` |
| `sous_tutelle` | instance (Fédération) | La fédération sous tutelle | 2013 · la Fédération | Le ministre a dissous le comité de Vaubourg ; tu es le comité provisoire, et la FédéMonde te donne trente jours. | `ministre / fedemonde / districts` |
...
Postulats dérivés des fins (« Et si… »), déblocables et écrits par le chapitre 30 : `le_revenant` (joueur suspendu, retour), `le_repenti` (dirigeant banni, président amateur, Réputation 90, Propreté 0), `le_vautour` (entraîneur viré trois fois, consultant), `couple_d_affaires` (Camille gère ta carrière), `le_coach_cassette` (jouer Anselmo Vaz). Chaque postulat reçoit dans son chapitre : un script d'ouverture (quatre ancres en S0 : slot 1, [10-11], 16, 17 ; trois en S1 ; deux rejouables en S2+), un réservoir d'au moins douze intrigues, dix manchettes, huit réactions, trois objectifs cachés, un `alarm_override` par jauge fragile.

### 3.3 Le graphe de transitions

**Le « rat de tribune » n'est pas un neuvième rôle.** Le brainstorm 03 § 3.6 fait commencer sa carrière de référence en « capo des ultras », qui n'existe pas dans les huit rôles. **Tranché** : on entre par le **joueur amateur** avec `ami_ultras` posé dès la saison 0 (variante de `am.tuto.bistrot`, ou `jp.tifo.local`), et la carrière court ensuite amateur → président amateur → président pro → Ligue → Fédération → tribune. Le capo reste Gégé, et c'est mieux : le joueur ne devient pas Gégé, il devient quelqu'un que Gégé aime. La carrière complète est écrite au chapitre 90 § 6.2.
...
| Joueur pro → DS | âge ≥ 30, Le club ≥ 60, `capitaine` | Vaubourg : « Reste, mais en costume. » | |
...
| Joueur pro → Sélectionneur ou Fédération | drapeau `legende` (50 sélections et un titre majeur) | Berthomier : la voie de la légende, très rare | |
| Adjoint (intérimaire) → Entraîneur | intérim gagné (deux victoires sur trois), ou offre d'un club de National | Vaubourg : « Le coach a été viré. Trois matchs. » | VESTIAIRE +10 (promotion interne) |
| Entraîneur → Sélectionneur | deux saisons Tribunes ≥ 60 et un titre ou une montée ; ou Berthomier à +1 ; ou le sélectionneur en place vient d'être viré (Nouvelle) | Berthomier : « On verra ça après le Congrès. Le Congrès, c'est demain. » | |
| Entraîneur → DS | Le président ≥ 70 après trois saisons au même club | Vaubourg : « Reste, mais en costume. » | |
...
| Président pro → Fédération | quatre saisons, Trésorerie ≥ 55, Actionnaires ≥ 55, trois alliés présidents à +2 (Malbec, Vaubourg, un troisième) | l'élection : Carte Destin double face, vote pondéré par Tribunes | |
| Président pro → Union Continentale | via le bloc des quatorze (« la voie ligue fermée »), Montoya à +2 | Montoya : « Assis ou debout ? » | |
...
**Le gabarit commence par trois dièses** (`### SCÈNE`), partout, dans tous les chapitres : c'est ce que lisent les outils d'extraction.

Règles d'importation : la réplique devient `text:` (≤ 200 caractères, avec le nom du locuteur et la didascalie courte en tête, comme les cartes existantes : « Gégé, écharpe au cou : « … » ») ; l'expression n'est pas un champ : c'est la relation qui la choisit, la didascalie sert à l'auteur pour écrire juste ; `{toi}` n'est permis que si le locuteur a une `adresse` ; le nom du joueur (`{prenom}`, `{nom}`, `{NOM}`) au plus une fois par carte, jamais dans un libellé, jamais sur deux cartes consécutives d'une même intrigue ; la conséquence devient `answer:` (**une à deux phrases, 140 caractères au maximum**, du présent, jamais une explication des effets — la carte affiche deux lignes, la troisième phrase tombe dans le vide ; quand il y a vraiment une troisième chose à dire, elle va dans une ligne d'Almanach ou dans un `epitaph_plus`) ; **Traces** liste les drapeaux posés qui ont une ligne d'Almanach (déclarés dans `traces:` de l'arc) ; **Réactions déclenchées** cite des ids `<rôle>.re.*` définis au gabarit § 4.4 ; **Lu plus tard par** cite les scènes, manchettes, alarmes ou set-pieces qui lisent la trace — **avec `ch. NN` pour un chapitre et `§ N` pour une section du chapitre courant** : un nombre nu est ambigu partout où un numéro de section coïncide avec un numéro de chapitre, et un intégrateur ira chercher un fichier `04` qui n'existe pas (c'est la couture, elle est obligatoire : une trace que personne ne lit est une erreur de build hors chantier). Un seul bouton = deux sorties identiques. Une scène de Nouvelle, de réaction ou d'alarme suit le même gabarit avec le champ **Moment** remplacé par sa mécanique (§ 4.4, § 4.6).
...
**Retrouvailles** : co.retrouvailles.<id>_sourire / _noir (deux répliques, **un seul bouton chacune**)
**Cartes propres** : 6 à 10 titres de scènes avec leur chapitre
**Paliers ∃** : quand la carte de palier existe déjà dans `content/`, la fiche la cite par id avec la mention ∃ au lieu d'en écrire une nouvelle
```

**La règle des retrouvailles** (tranchée après relecture). Le moteur enfile la carte de retrouvailles sans prévenir, dans les créneaux [2,6] qui suivent une Passation : **deux boutons y seraient un choix hors contexte**. Donc :
- `co.retrouvailles.<id>_sourire` et `_noir` sont des **répliques à un bouton** (deux sorties identiques, gabarit § 4.6). Ce sont les deux seuls ids que le champ `retrouvailles:` de `characters.yaml` cite, et rien ne change au moteur.
- Les **troisièmes retrouvailles** (`_fantome`, `_telephone`, `_enterrement`, `_carnet`, `_cassette`, `_tapis`, `_corbeaux`, `_hymne`, `_cabinet`, `_carte_postale`, `_place_vide`, `_succession`, `_cousin`, `_banc_en_face`, `_eglise`, `_soleil`, `_dimanche`, `_bord_de_terrain`, `_ardoises_2020`, `_14b_court`…) ne sont pas des retrouvailles : ce sont des **cartes propres `once` du réservoir**, à deux boutons, conditionnées par `statut_ok:` et par l'année. Elles gardent leur id en `co.retrouvailles.*` pour ne rien casser, et leur fiche porte la ligne **Type : carte propre `once`**.
- **Un id, une scène.** Deux chapitres ne peuvent pas écrire deux contenus sous le même id ; en cas de collision, le chapitre 01 fait foi (il est propriétaire de l'espace `co.<personnage>.*`) et l'autre renomme.
...
**Épitaphe** : **deux phrases, jamais trois**, au passé composé ou au présent, qui nomment le joueur **une fois** ({prenom} {nom}) et accordent en genre ({pg, select, f{e} other{}}) ; la troisième phrase, quand elle est bonne, descend dans l'`epitaph_plus`, qui est fait pour ça
...
- Manchette : **trois axes, et trois seulement** (précisé après relecture ; le troisième était utilisé en silence, il est maintenant légal). `une.<postulat>.<mot>` : la manchette d'un postulat. `une.generic.<mot>` : la manchette d'état, tous rôles, tous postulats — c'est aussi le **secours déclaré** quand la manchette propre n'est pas écrite. `une.<journal>.<mot>` avec `quotidien | gazette | echo` : la manchette de **signature d'un titre**, celle qui n'appartient à aucun postulat parce qu'elle appartient à une ligne éditoriale (« Le Rosé » note un président sur vingt, « Au local » raconte le radiateur).
- **Jamais un nom de personnage ni de voix sans portrait en premier segment** : `une.gerard.x` et `une.vasseur.x` sont faux, et ont été renommés (`une.village.gerard_soleil`, `une.formation.vasseur`). Le personnage se met dans le **mot**.
- **Une manchette citée est une manchette écrite.** Une ligne « Lu plus tard par » ne peut nommer que des `une.*` qui existent au gabarit § 4.5 ; tant qu'elles n'existent pas, la ligne cite `une.generic.*`, qui est le **secours déclaré pour tous les rôles**.
...
**Les huit notations ajoutées après relecture** (elles étaient utilisées sans être au gabarit ; elles y sont maintenant, une ligne et un exemple chacune) :

| Notation | Ce qu'elle fait | Exemple |
|---|---|---|
| `rand: [{p, effets}, {effets}]` | un aléa unique, à deux branches, jamais plus ; il ne décide jamais d'une trace ni d'une fin | `rand: [{p: 0.5, tribunes: "++"}, {tribunes: "−−", vestiaire: "−"}]` |
| `var: {<nom>: "+1"}` | un compteur de monde ou de postulat, lu par un `if` (`vars.tiroirs >= 4`) | `var: {tiroirs: "+1"}` |
| `world: {<clé>: <valeur>}` | une entité du monde change (le capitaine, la star, le tournoi) | `world: {capitaine: mbako}` |
| `role: <rôle>` | la Carte Destin change le rôle joué à la Passation | `role: entraineur` |
| `end: <id de fin>` | la carte termine la carrière ; l'id doit être une plaque écrite au ch. 30 | `end: in_congres` |
| `schedule: [{card, in: [a,b]}]` | une carte est programmée dans une fenêtre de créneaux, cette saison | `schedule: [{card: in.dossier.video_apres, in: [14,14]}]` |
| `chain: <id de chaîne>` | la carte ouvre une chaîne de set-pieces (Tournoi, Coupe, les soixante heures) | `chain: pr.ligue_fermee` |
| `elimination: <tour>` | **n'est pas un effet de carte** : c'est une entrée de `content/balance.yaml` appliquée par le moteur à la clôture d'une chaîne (`{poules: 20, tour: 25, demie: 30, finale: 35}`), parce qu'elle dépasse l'échelle symbolique (`+++` = 18) | déclaré dans `balance.yaml`, cité par la scène |

**Le nom d'un postulat est un drapeau.** Onze postulats étaient lus par `flag('…')` sans être posés par personne. Règle : **le démarrage d'un postulat pose un drapeau qui porte son nom**, comme `promu` le fait déjà (`apres_fiasco`, `pays_emergent`, `heritage_empoisonne`, `sous_tutelle`, `banc_dore`, `binational`, `section_feminine`, `bout_du_monde`, `geant_dechu`, `fusion_proposee`, `village_fusion`…). On écrit `flag('promu')` **ou** `postulat == 'promu'`, jamais les deux dans la même bible : la notation retenue est **`flag('<postulat>')`**.
...
|---|---|---|---|---|---|
| `01_personnages_terrain.md` | fiches complètes (§ 4.2) des personnages de camp `terrain`, `selection` et `famille` : Gégé, Vukić, Bréhaut, Sabatier, Camille, Corven, Mbako, Vecchio, mère de Mbako, Vaz, Vogler, Rouvier, Dembo, Fauvel, Brissac, Gérard, Dédé, Paulette, Sacha ; pour chacun : trajectoire 1990-2050, adresse dans les huit rôles, paliers ±3 (deux scènes), retrouvailles (deux répliques), six à dix cartes propres | 19 fiches ; 38 scènes de palier ; 38 répliques de retrouvailles ; ≥ 6 cartes propres par fiche (titre + une ligne, ou scène complète pour les trois premières) | tous ceux de la liste | mbako_vendu, mbako_lance, pacte_gege, onze_du_virage, gigi_staff, genou_opere, flacon_b, camille_ici, divorce, clow_ingrat, brassard_gigi, bus_menace, derby_perdu, sacha_nee | 02 |
| `02_personnages_direction_instances.md` | fiches des personnages de camp `direction` et `instances` : Fardelli, Massenet, Vaubourg, Aubert, Berthomier, Ilyas, Josiane, Léa, Bambini, Dauzat, Vialat, Amsel, Colline, La Plume, Vence, Solvang, Barbier, Malbec, Montoya, Dupuis, Pichon, Roux ; mêmes rubriques ; plus la table « qui préside quoi, quand » (Fédération, Ligue, Union, FédéMonde, ministère, 1990-2050) | 22 fiches ; 44 scènes de palier ; 44 répliques de retrouvailles ; la table des mandats | tous ceux de la liste | naming_signe, club_actif, enveloppe_promise, fede_dossier, president_ami, selection_refusee, vote_achete, diplome_arrange, commission_lettre, ligue_fermee_signee, mondial_desert, aubert_ministre | 01 |
| `10_scenarios_joueur.md` | joueur amateur et joueur pro : pour chacun des postulats `pepite`, `fin_de_contrat` (reprendre et compléter le plan de la spec § 4.3-4.4 sans le contredire), `village_endette`, `lache_academie`, `retour_croises`, `binational`, `banc_dore`, `capitaine_dechu` : script d'ouverture (S0 : 4 ancres ; S1 : 3 ; S2+ : 2), réservoir, réactions, manchettes, objectifs ; le tutoriel (douze cartes fixes de Trébignac avec Josiane et Vecchio) | par postulat : 1 script (9-11 scènes), ≥ 12 intrigues (4-6 scènes chacune, fiche § 4.3), ≥ 8 réactions, ≥ 10 manchettes, 3 objectifs ; 12 scènes de tutoriel ; 20 temps forts de Grand Match (famille joueur) | Fardelli, Vukić, Vaubourg, Bréhaut, Dembo, Mbako, Vecchio, Sabatier, Rouvier, Léa, Vence, Gégé, Camille, Solvang, Barbier, Dédé, Pichon, Gérard, Dupuis, Paulette, Berthomier, Fauvel, Ilyas | pose : genou_opere, capitaine, international, binational_choisi, offshore, mouton_noir, special, enfant_du_pays, essai_pro, patron_furieux ; lit : mbako_vendu (il joue contre toi), selection_refusee, pacte_gege (« ton nom sur la bâche ») | 11 |
| `11_scenarios_entraineur.md` | `promu` et `interimaire` : ne pas réécrire ce qui existe (85 + cartes) mais **compléter** le réservoir de la spec § 4.1-4.2 (les intrigues marquées « à écrire » : salaires en retard, espion dans la haie, cote du promu, cartons de Camille, brassard de Bréhaut, l'adjoint qui dîne, l'enveloppe, la pharmacie, le fils du président, le retour de Mbako, Gigi au staff, le dossier Massenet, la commission de discipline ; tout le réservoir de l'intérimaire) ; puis `bout_du_monde`, `six_mois`, `section_feminine` en entier | promu : 13 intrigues à écrire ; intérimaire : script + 9 intrigues propres + réactions + manchettes + objectifs ; trois postulats nouveaux complets (grille standard) ; 20 temps forts (famille banc) | Vaubourg, Josiane, Vukić, Bréhaut, Vecchio, Mbako, mère de Mbako, Gégé, Ilyas, Fardelli, Massenet, Léa, Corven, Sabatier, Rouvier, Dembo, Vaz, Vogler, Berthomier, Brissac, Malbec, Camille, Aubert | pose : pacte_gege, onze_du_virage, mbako_vendu, mbako_lance, naming_signe, club_actif, gigi_staff, enveloppe_promise, flacon_b, salaires_retard, vukic_dauphin, clow_ingrat, diplome_arrange, derby_perdu, bus_menace ; lit : genou_opere, capitaine, president_ami, fede_dossier | 10, 12 |
| `12_scenarios_directeur_sportif.md` | `vendre_trente`, `coach_intouchable` : le mercato comme sous-paquet dense (deux fenêtres par saison, six à huit offres concrètes chacune), les quatre agents persistants (Fardelli le bulldozer, Solvang la discrète, la mère de Mbako, un père-agent générique), l'Inspecteur, le coach (Vaz ou Vogler selon le postulat), le fax de 23 h 58, l'algorithme contre l'œil (Barbier) | grille standard × 2 ; plus 24 cartes d'offres de mercato (12 par fenêtre, avec variables {joueur}, {prix}, {agent}) ; 8 alarmes ; 8 fins (gabarit § 4.8) | Vaubourg, Ilyas, Fardelli, Solvang, mère de Mbako, Barbier, Vaz, Vogler, Bréhaut, Josiane, Vialat, Massenet, Vence, Dembo, Mbako, Malbec | pose : commission_occulte, fax_rate, algorithme_adopte, dembo_vendu, coach_demission ; lit : mbako_vendu, naming_signe, club_actif, enveloppe_promise, genou_opere (visite médicale), president_ami | 11, 13 |
| `13_scenarios_president.md` | président amateur (`fusion_imposee`, `coupe_du_village`) et président pro (`geant_dechu`, `rachete_fonds`) : la buvette, la mairie, Gérard, Dupuis, la Coupe qui amène Capitale FC ; puis les actionnaires, l'entraîneur qu'on vire ou qu'on confirme, Gégé sous les fenêtres, Almadis, la Ligue fermée (huit cartes de six heures), le sponsor qui devient propriétaire vu du bureau, les écoutes, la valise | grille standard × 4 ; la chaîne « 60 heures » (8 scènes) ; 16 fins (8 + 8, gabarit § 4.8) ; 20 temps forts (familles président et amateur) | Aubert, Roux, Gérard, Dédé, Dupuis, Pichon, Paulette, Vecchio, Josiane, Léa, Ilyas, Malbec, Montoya, Bréhaut (DS), Gégé, Vukić/Vogler/Vaz (l'entraîneur), Massenet, La Plume, Vialat, Amsel, Colline, Fardelli, Camille, Sacha | pose : fusion_signee, naming_signe (côté bureau), club_actif, ligue_fermee_signee, commission_lettre, ecoutes, coach_vire, president_ami, stade_promis, gerard_parti ; lit : pacte_gege (Gégé te rappelle le pacte du coach), mbako_vendu, enveloppe_promise, fede_dossier, aubert_ministre, boucher_sponsor | 12, 14 |
| `14_scenarios_selectionneur.md` | `pays_emergent`, `apres_fiasco` : le calendrier en années civiles (quatre fenêtres, une carte Liste par fenêtre : deux dilemmes), la chaîne Tournoi (poules en Carte Match, chaque tour en Grand Match, sans respiration), le bus, l'avion des primes, le binational, l'hymne, le ministre, le verre de vin, la demande en mariage, le fils du ministre, l'ancien sélectionneur consultant qui te savonne la planche | grille standard × 2 ; 8 cartes Liste (deux par fenêtre) ; la chaîne Tournoi (12 scènes : trois tours × trois temps forts + annonce + après) ; 8 fins ; 20 temps forts (famille sélection) | Berthomier, Brissac, Aubert (ministre après 2002), Fauvel, Mbako, Vecchio, Dembo, Vogler (l'adversaire), Sabatier, Rouvier, Vence, Massenet, Fardelli, Malbec, Josiane, Camille, Sacha, Bambini (la remise du trophée), Dauzat (le contrat de minuit) | pose : selection_refusee, bus_descendu, mutinerie_matee, hymne_impose, binational_bloque, fils_du_ministre, grand_match_perdu ; lit : international, binational_choisi, capitaine, genou_opere, mbako_vendu, gigi_staff (Gigi descend le premier), president_ami | 13, 15 |
| `15_scenarios_instance.md` | `heritage_empoisonne`, `sous_tutelle` (Fédération), `tournoi_desert` (Union), `elu_surprise` (FédéMonde) : les mandats de quatre ans, quatre dossiers par an (Cartes Événement double face : arbitrage vidéo, calendrier, droits télé, attribution du Mondial, 48 équipes, égalité des primes, un Mondial tous les deux ans, les ouvriers des chantiers, la grève mondiale), le Congrès annuel, la Campagne (quatre promesses à quatre confédérations), la réélection ; les valises de l'hôtel du Lac, le raid à l'aube, la variante lanceur d'alerte | grille standard × 4 ; 16 Cartes Événement double face ; la Campagne (4 scènes) ; la chaîne des valises (6 scènes) ; 8 fins ; 20 temps forts (famille instance : le tirage au sort en direct, le trophée à côté du dictateur, la panne de la vidéo en finale) | Berthomier, Vaubourg, Malbec, Roux, Bambini, Dauzat, Josiane, Amsel, Vialat, Colline, La Plume, Léa, Vence, Ilyas, Montoya, Fauvel (le syndicat), Brissac, mère de Mbako (l'agente des vingt), Aubert (ministre), Sacha (l'ONG), Camille | pose : fede_dossier, vote_achete, mondial_desert, video_adoptee, ligue_fermee_signee (côté Union), reforme_votee, radie, lanceur_alerte ; lit : president_ami, enveloppe_promise, flacon_b, ecoutes, commission_lettre, selection_refusee, hymne_impose, diplome_arrange | 14, 20 |
| `20_journaux.md` | pour chacun des trois journaux et de Télé-Stade : la voix (dix règles de style par titre), les rubriques, les plumes, les prix par décennie ; les manchettes génériques (tous rôles) ; les manchettes de chaque postulat nouveau (≥ 10 chacune, dont ≥ 3 sur des traces) ; les Unes de fin de carrière (une par famille de fin) ; la météo de la Marmite (les quatre états, dix formulations chacune) ; les brèves types ; les « on nous écrit » | 4 voix ; ≥ 20 manchettes génériques ; ≥ 10 par postulat nouveau (21 postulats × 10 = 210, coordonnées avec les chapitres 10-15 qui en fournissent les titres et les conditions : le chapitre 20 harmonise, ne réécrit pas) ; 12 Unes de fin ; 40 lignes de météo ; 30 brèves | Massenet, Léa, La Plume, Vence, Ozanne (voix), le Rosé (voix), le stagiaire de l'Écho (voix) | toutes les traces de § 5.2 (une manchette par trace au minimum) | 15, 31 | **Propriétaire, après relecture, des Nouvelles datées `co.nv.<annee>_*` et des drapeaux `monde_*` (les 88 Nouvelles de 1990 à 2050) ; doit livrer une seconde passe d'environ 120 manchettes, en commençant par les 38 traces orphelines du ch. 02 et les 22 du ch. 13, et compléter les gabarits d'Almanach de 24 à 40.**
| `30_setpieces_alarmes_fins.md` | les set-pieces des sept beats pour chacun des huit rôles (variantes lues sur les traces et le fil rouge, secours inclus) ; les alarmes (deux par jauge par rôle, huit rôles, avec `alarm_overrides` par postulat) ; le piège du centre (dix cartes) ; toutes les fins au gabarit § 4.8 (les 91 plaques du brainstorm § 2.9 dont 23 existent : ne pas réécrire les 23, écrire les autres avec `epitaph_plus`) ; les postulats dérivés (« Et si… ») ; les Cartes Destin de transition (une par arête de § 3.3, avec la carte « Le monde réagit ») | 8 rôles × 7 beats × ≥ 5 variantes = 280 lignes ; 64 alarmes ; 10 cartes du piège ; ≈ 68 fins nouvelles + 23 `epitaph_plus` de relecture ; 5 postulats dérivés ; ≈ 30 Cartes Destin | tous les patrons (Vaubourg, Fardelli, Berthomier, Aubert, Ilyas, Bambini, Roux, Malbec), les chœurs (Josiane, Vukić, Gérard, Dauzat), Massenet (« Ton pari »), Vence (le plateau), Sabatier (le médecin après 70 ans) | toutes les traces de § 5.2 ; en particulier vukic_dauphin, finale_gigi, pacte_gege, mbako_vendu, club_actif, ecoutes, vote_achete, radie, divorce, sacha_nee | 31, 90 |
| `31_anecdotes_et_almanach.md` | **corrigé après relecture : les Nouvelles datées `co.nv.<annee>_*` et les quarante-neuf drapeaux `monde_*` appartiennent au chapitre 20**, qui les a écrites (quatre-vingt-huit, 1990-2050) ; le chapitre 31 garde et doit livrer : les **Nouvelles « à côté »** (`co.nouvelle.fd_*`, non datées), les anecdotes et gags de décor, les **douze cartes-légendes** (une par saison au plus), **L'Almanach du Ballon** (dix entrées types par décennie) et les **quarante-deux lignes d'enterrement** (une par personnage à statut, Rossard compris) | 12 cartes-légendes ; 6 blocs de 10 entrées d'Almanach du Ballon ; ≥ 30 anecdotes (gabarit § 4.9) ; **42 lignes d'enterrement** ; les Nouvelles « à côté » | tous (une Nouvelle = un locuteur) | lit toutes les traces de monde (`monde_*`, posées par le ch. 20) | 30, 90 |
...
| 3 | `mbako_garde` ∃ | 11 | 12 (l'option Almadis), 20 |
...
| 7 | `naming_signe` ∃ | 11 · en.nassir (naming) ; 13 · Arena Dupuis / Arena Almadis | 10 (« le stade s'appelle comme une boisson »), 12, 13, 20 (« ARENA ALMADIS »), 31 (Nouvelle S1) |
| 8 | `club_actif` ∃ | 11, 13 · le rachat | 12 (budget illimité, conditions), 13 (« Notification »), 15 (le fair-play financier), 30 (en_placard plus) |
| 9 | `club_a_lancienne` ∃ | 11, 13 · refus de toute la chaîne Ilyas | 13 (trait « Club à l'ancienne »), 20, 30 (objectif) |
...
| 20 | `clow_ingrat` ∃ | 11 · en.mentor_clow | 01 (pas de testament ; « le fils de Corven » refuse ta lignée), 10 (le stage du diplôme), 20, 90 |
| 21 | `diplome` ∃ / `diplome_arrange` | 10 (jp.diplome_joueur), 11 (en.diplome) / 11 · la dérogation arrangée | 30 (Carrefour), 15 (Brissac ressort le dossier), 11 (dossier Massenet), 20 (« LE COACH SANS PAPIER ») |
...
| 30 | `selection_refusee` | 10 · forfait pour le club ; 14 · le joueur qui refuse ta liste | 02 (Berthomier à −1), 14 (« on ne dit pas non deux fois »), 15 (le règlement des forfaits), 20 |
...
| 33 | `president_ami` | 11, 12 · DIRECTION ≥ 80 trois saisons ou `homme_president` ∃ | 13 (Vaubourg te traite en égal, ou te rappelle qui t'a fait), 14 (Berthomier se méfie de l'homme de Vaubourg), 15 (le bloc Vaubourg au Congrès), 30 (sl_homme_president, en_placard plus) |
| 34 | `fede_dossier` | 15 · le dossier ouvert sur toi ou par toi ; 11 · la commission de discipline | 02 (Dauzat, Amsel), 13 (la rétrogradation administrative), 14 (Berthomier te lâche), 20 (La Plume), 30 (fins judiciaires) |
...
| 36 | `mondial_desert` | 15 · l'attribution | 14 (le Mondial d'hiver : le calendrier de la sélection), 13 (le club frère à Al-Dorado), 31 (la Nouvelle de 2030), 20 |
| 37 | `ligue_fermee_signee` | 13 · les 60 heures ; 15 · côté Union | 13 (cartes de mépris), 14 (exclure leurs joueurs des sélections), 15 (le bloc des quatorze), 90 (l'initiateur devient ennemi de la lignée), 20, 30 (fin *La Ligue fermée*) |
...
Traces de monde posées par les Nouvelles datées (chapitre 31), lues par tous : `monde_libre_1993` (1995), `monde_titre_2002`, `monde_video` (2016), `monde_flux` (2007), `monde_ligue_fermee` (2019), `monde_greve` (2026), `monde_franchises` (2040), `monde_ecus` (2002). Traces déjà déclarées et à réutiliser plutôt qu'à doubler : `bus_menace`, `otage_kop`, `homme_president`, `boucher_sponsor`, `fidele`, `parti_tete_haute`, `tribune_a_renover`, `presse_franc`, `pari_promu`, `pari`, `vitamines`, `galactique`, `pisteur`, `mutinerie`, `porte_ouverte`. Toute trace nouvelle qu'un chapitre invente doit être **lue par un autre chapitre** avant d'être livrée, et inscrite dans la matrice du chapitre 90.

---

### 5.3 Les commandes au chantier données (ce que `content/` doit changer)

Les auteurs n'écrivent pas dans `content/`. Ce paragraphe est le bon de commande : il liste ce que la bible a tranché et que le chantier données doit appliquer. **Les ids techniques ne bougent pas** (rien ne casse) ; ce sont les noms affichés et les textes qui changent.

**a. Les six noms à changer dans `characters.yaml` (champ `name` seulement).** `clow` → **Dan Corven** · `klopf` → **Vogler** · `loco` → **Anselmo Vaz**, dit « le Muet » · `legruet` → **Noé Berthomier** · `aulard` → **Jean-Marie Vaubourg** · `meneche` → **Pierre Massenet** · `nassir` → **Cheikh Ilyas**. Motif : chacun portait, avec sa fonction, plus de deux traits reconnaissables d'une personne réelle (interdit § 6.1.1 et règle § 2.1.7).

**b. Les tics et les blessures à réécrire.** `clow` : tic « Je ne dirais pas que j'étais un grand. Je dirais que j'étais devant. » ; blessure : cinquante-neuf jours à Capitale FC en 1971, le télégramme gardé ; il ne boit pas, il a un verre d'eau plein devant lui. `klopf` : les manches remontées et la montre au-dessus du poignet remplacent le dentier ; blessure : il a **gagné** trois finales et n'a jamais été aimé. `loco` : le seau et la cassette restent ; l'espion passe de la haie au **car de la presse**, et n'est plus le sien : c'est celui du coach de `{rival}`.

**c. Les textes de cartes existantes à réécrire** (mêmes ids, même mécanique) : `en.clow.top_un`, `en.clow.44_jours` (« Cinquante-neuf jours dans un grand club »), `en.clow.verre`, `arc_clow_presse.yaml` et `portraits.yaml` (le commentaire) ; `jp.mercato.arret_bosquet` (garder l'id, écrire « **l'arrêt Vaneste** ») ; `en.evt.gerard` (« il est **au soleil** », jamais un pays réel) ; `co.nv.*` touchées par la chronologie du § 1.1.

**d. Les drapeaux à ajouter là où ils manquent.** `en.evt.gerard` : `set: [gerard_parti]` **sur les deux sorties** (neuf scènes lisent `gerard_parti` et personne ne le posait). `jp.famille.naissance` : `set: [sacha_nee]` **sur les deux sorties** (huit chapitres lisent `sacha_nee`), et `jeune_papa` renommé **`jeune_parent`** dans `flags.yaml` (le personnage joué peut être une femme).

**e. Les drapeaux de postulat.** Le démarrage de chaque postulat pose un drapeau à son nom, comme `promu` : `apres_fiasco`, `pays_emergent`, `heritage_empoisonne`, `sous_tutelle`, `banc_dore`, `binational`, `section_feminine`, `bout_du_monde`, `geant_dechu`, `fusion_proposee`, `village_fusion`. Les déclarer dans `flags.yaml`.

**f. Le statut `mort`** est ajouté à l'énumération des statuts (§ 2.4 bis).

**g. La passe de nettoyage des « Lu plus tard par ».** Avant l'import, toute `une.*` citée et non écrite est **retirée** de la ligne et remplacée par `une.generic.*` ; le lint ne doit plus voir de lecteur fantôme. La seconde livraison de manchettes du chapitre 20 les réintroduit une par une, quand elles existent.

**h. Les exclusions mutuelles à poser** : `exclusive_with` entre `pr.gerard.trahison_caisse` (ch. 01) et `pr.gerard_a_fui` (ch. 13) — les deux posent `gerard_parti`, Gérard ne part qu'une fois.

**i. Les `{toi}` d'Aubert, Vialat et Amsel** sont **légaux** : `{toi}` rend l'`adresse`, et leur adresse est « madame ou monsieur {nom} » sur les trois visages. Ce n'est pas un tutoiement, c'est leur vouvoiement, et c'est leur caractérisation. Ne pas les remplacer.

**j. Le compteur du Cimetière** affiche « Fins découvertes n / **112** » (chapitre 30 § 5.1, recompté après déduplication) ; `endings.yaml` doit tomber sur le même nombre.
...
2. **Aucun fait réel transposé** de manière reconnaissable : pas de date qui colle à un événement réel, pas de score célèbre, pas de phrase célèbre. Les anecdotes du brainstorm 04 § 4.4 sont des *situations* (la main, le bus, les valises, la ligue fermée) : on les écrit sans leur décor réel, avec nos villes, nos années, nos personnages ; la spec § 1.5 a déjà remplacé trois Nouvelles pour cette raison, on continue dans cet esprit. Un scandale ne s'attache jamais à un personnage qui partage deux traits avec quelqu'un de réel. **Et la règle vaut pour l'horloge du monde autant que pour les visages** : le tableau du § 1.1 a été audité une fois, année par année, et aucune de ses cellules ne coïncide plus avec l'événement réel qui lui correspondait (l'arrêt en 1993, le Continental gagné chez nous en 1996, le Grand Stade en 1996, les quotas en 1997, le Mondial raté en 1998, le titre mondial en 2002 et à six mille kilomètres, la vidéo en 2014, les quarante-huit équipes votées en 2015 et jouées en 2022, la Ligue fermée en 2019 à quatorze clubs et soixante heures, le Mondial d'hiver en 2030). Le tableau garde ses tendances ; il a perdu son calendrier. Toute Nouvelle nouvelle passe le même contrôle avant d'entrer.
3. **Aucun identifiant de modèle, d'outil ou de génération** nulle part, pas même en commentaire.
4. **Longueurs** : réplique ≤ 200 caractères (cible 160), deux phrases ; libellé ≤ 28 caractères, verbe à la première personne, jamais « Oui / Non » ; manchette ≤ 44 caractères rendus ; ligne d'Almanach ≤ 120 ; épitaphe deux phrases, jamais trois ; `answer` **une à deux phrases, 140 caractères au maximum**.
...
- [ ] Deux libellés ≤ 28, première personne, distincts, **sans « Oui » ni « Non » en tête de libellé** (« Non, pas l'hôpital » devient « Pas l'hôpital » ; « Non : il est exclu ce soir » devient « Je l'exclus ce soir »), sans le nom du joueur.
- [ ] La conséquence tient en une à deux phrases et 140 caractères.
...
- [ ] La scène tient sans le chapitre : un intégrateur qui ne l'a pas lu peut la copier dans un YAML. **La fiche courte est interdite pour toute scène qui pose une trace ou porte une issue** : elle est réservée aux variantes de texte d'une scène déjà dépliée au gabarit § 4.1.
- [ ] Une scène rejouable (`_encore`, rituel S2+) **recopie ses deux sorties** ou n'existe pas comme id séparé : « sorties identiques à R2 » n'est pas une carte, c'est une note.
...
- [ ] Les années sont cohérentes avec § 1.1 (pas de vidéo avant 2014, pas d'écus avant 2002, pas de Flux avant 2008, pas de Kick avant 2021, pas de fax après 2010).
