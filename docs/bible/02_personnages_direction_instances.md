...
2. **La fonction est datée.** Le tableau des mandats § 2 dit qui préside quoi. Une scène qui fait parler « Vaubourg, président de la Fédération » porte `year >= 2008 && year < 2016`. Une scène qui le fait parler « président de {club} » porte `year < 1998` ou un `chars.aulard.statut`.
...
Le monde « par défaut » est celui que le joueur trouve s'il n'y monte pas lui-même. Dès qu'il occupe une case, la case d'après devient « le suivant » (une voix sans portrait) ou le personnage à statut déplacé d'une case. Les âges sont ceux de la charte (âge en 1990, +1 par saison) ; on ne les discute pas, on en fait des répliques (« Berthomier a soixante-trois ans depuis 1990 »).
...
|---|---|---|---|---|---|---|---|---|
| 1990-1996 | Berthomier (depuis 1988) ; Dauzat secrétaire général | « un président qu'on ne nomme pas » (le syndicat des présidents) ; Vaubourg et Malbec s'y détestent | « le président de l'Union », sans portrait ; siège à l'hôtel du Lac | Bambini (depuis 1986) | « le ministre », sans nom | Vialat, l'Inspecteur (depuis 1989) | Brissac DTN (depuis 1988) · Rossard sélectionneur des Cobalts (1986-1994) · Colline arbitre de D1 (le sifflet) | Massenet au Quotidien (« Hors micro ») ; Léa à L'Écho ; Vence en zone mixte pour Télé-Stade ; La Plume à la Gazette |
| 1996-2000 | Berthomier réélu 1996 (de sept voix) | Vaubourg président 1998 | idem | Bambini réélu | Aubert députée 1997 ; « le ministre » toujours sans nom | Vialat | Brissac · Colline (Coupe d'été 1996 : les trois centimètres sifflés contre son pays) | idem ; Rossard consultant Télé-Stade (1995), « moi, à sa place » ; le Quotidien titre sur les Cobalts de 1996, champions chez eux |
| 2000-2004 | Berthomier réélu 2000 (de neuf voix) | Vaubourg | idem | Bambini | **Aubert ministre 2002** (`aubert_ministre`) | Vialat | Brissac · Colline raccroche le sifflet (45 ans, 2001), consultant arbitrage à Télé-Stade | Massenet consultant Télé-Stade 2003 ; Vence présente « Le plateau » 2003 ; Médiacrash prend les droits |
| 2004-2008 | Berthomier, dernier mandat ; il « verra ça après le Congrès » de 2008 | Vaubourg (Malbec attend) | Berthomier candidat 2008 | Bambini | Aubert | Vialat | Brissac · Colline « désignateur » officieux | Massenet ; Gégé sur Radio Tribune (2004-2011) ; le Flux (2007) |
| 2008-2012 | **Vaubourg 2008** (Malbec battu, « sans passer par les districts ») ; Dauzat | **Malbec 2008-2012** | **Berthomier 2008** (élu de neuf voix : il ne fait jamais mieux) | Bambini réélu 2010 ; Ilyas au comité du Mondial (`mondial_desert` 2010) | Aubert (jusqu'en 2012) | Vialat | Brissac jusqu'en 2010, puis Castan (DTN 2010-2030, ch. 01) ; **Colline responsable de l'arbitrage 2008** | Massenet directeur d'antenne 2012 ; Barbier à la retraite (2006), l'« algorithme » naît (2008) |
| 2012-2016 | Vaubourg réélu 2012 ; 2013 : « le ministre » dissout le comité (`sous_tutelle`) | **Bréhaut 2012** (Malbec s'arrête à soixante-seize ans ; il dit que c'est lui qui l'a décidé) | Berthomier réélu 2012 ; **Dauzat secrétaire général de l'Union 2012** | Bambini se représente à 79 ans (2011), puis se retire en 2016 | « le ministre », sans nom (2012-2020) | Vialat | Castan · Colline | Vence, Massenet ; la vidéo (2014) |
| 2016-2020 | **toi, sinon Malbec 2016** (« la voie sans les districts », enfin) | Bréhaut | Berthomier retraité 2016 → « le dauphin » de Bambini glisse ici, ou toi | **« le dauphin », ou toi** (`elu_surprise` 2016) ; Josiane secrétaire de la FédéMonde (2016-2022) | idem | Vialat | idem | **Léa rédactrice en chef du Quotidien 2018** ; Solvang reprend le carnet de Fardelli (2018) ; Vence directrice de l'info (2020) |
| 2020-2028 | « le président » (voix sans portrait, 2020-2028 : élu par les districts du fils de Roux ; Fauvel préside le syndicat des joueurs jusqu'en 2030, ch. 01) ; **limite d'âge de 75 ans votée au Congrès de 2024, pour la Fédération, l'Union et la FédéMonde seulement** : la Ligue, syndicat privé de présidents, l'a refusée en trois minutes, et le Congrès a refusé depuis deux dérogations (`derogation_age`) | Bréhaut (2020-2028) | toi, ou « le président de l'Union » | « le dauphin » réélu 2020, **Dauzat secrétaire général de la FédéMonde 2020** ; Amsel frappe à l'hôtel du Lac (2021) | « le ministre » ; Sacha dans l'ONG des ouvriers (2022) | Vialat | Colline face à « la machine » (2027) | Massenet publie ses mémoires (2025) ; Kick (2024) ; Berthomier meurt (2020) |
| 2028-2040 | Bréhaut 2028-2032 (de la Ligue à la Fédération ; il s'arrête à soixante-quinze ans pile, la limite qu'il avait votée) ; **Mbako 2032** (« le retour », par défaut) | **Ilyas 2028-2040** (« le fonds préside la Ligue » ; il a quatre-vingt-quatre ans à la fin et il a fait écrire que la Ligue n'a pas de limite d'âge) | « le président de l'Union » | « le conseil » : plus de patron identifiable | idem | l'agence de notation (2033 : Vialat refuse de la diriger, c'est « l'algorithme » qui note) | « la machine » | Vence se retire (2035) ; « la voix générée d'un ancien joueur » commente ; L'Écho, le dimanche |
...
| **Massenet** | une brève dans L'Écho, signée de lui (0,5) | la première interview, le mème (1) | la conférence, le dossier (1,5) | la vitre baissée le dernier jour du mercato (1) | — | le direct, « virer le coach ? » (1) | l'ancien sélectionneur consultant qui te savonne, c'est lui qui tend le micro (1,5) | ses mémoires te citent ; le plateau du Congrès (1) |
| **Vaubourg** | — | le prix, « petit » (1) | le patron (3) | le patron qui achète sans toi (2) | — | **ton égal**, puis patron de la Ligue, puis président de la Fédération (2) | le président de club qui refuse de libérer ses joueurs (0,5) | **ton électeur, puis ton adversaire au Congrès** (2) |
...
| **Berthomier** | — | la sélection (0,5) | le diplôme, salle 3 (0,5) | — | — | le Congrès, une voix contre toi (0,5) | **celui qui te nomme et te lâche** (2) | prédécesseur, mentor ou adversaire (1,5) |
| **Ilyas** | — | l'exil doré (0,5) | sponsor → naming → prêt → rachat (1,5) | le budget illimité et ses conditions (2) | — | l'actionnaire ou le propriétaire (2) | le Mondial d'hiver : le calendrier (0,5) | le tournoi du désert, les votes (1,5) |
...
| **Montoya** | — | le transfert du siècle (0,5) | le Castel Montoya t'appelle à mi-saison (0,5) | — | — | **« Assis ou debout ? »** (1) | — | le bloc des quatorze (1) |
...
← **Qui, et où ?** — effets : vestiaire −−, tribunes −, set: star_vendue_dos, char: {dembo: {statut: vendu}} — *Il dit le nom de {rival}. Il ne dit pas le prix : il le laisse à Massenet.*
...
→ **D'argent : dis-leur oui** — effets : caisse ++, direction −−, set: premier_appel, schedule: [{card: co.carrefour.offre_fardelli, in: [4,9]}] — *Le président l'apprend par Massenet. Massenet l'apprend par Fardelli.*
...
## PIERRE MASSENET  (`meneche`)
**Fonction** : journaliste, chroniqueur du Quotidien (« Hors micro »), puis consultant Télé-Stade (2003), directeur d'antenne (2012) · **Genre** : m · **Âge en 1990** : 42 · **Camp** : direction · **Fenêtre** : 1990-2025, puis `retraite` (ses mémoires sortent en 2025 ; il y a un chapitre à ton nom) ; meurt en 2032, en direct, pendant un plateau d'anciens · **Suivant** : Vence à l'antenne ; « le Rosé » (voix) au papier
...
**Cartes propres** : *La cote du promu* (ch. 11, ∃) · *Le dossier Massenet* (ch. 11, gabarit dossier, six variantes sur les traces) · *Le mème* (ch. 10) · *La vitre de la voiture* (ch. 12) · *Virer le coach ?* (ch. 13, en direct) · *L'ancien sélectionneur consultant* (ch. 14) · *Ton pari* (ch. 30, set-piece Bilan) · *Le chapitre à ton nom* (ch. 31, 2025)
...
**MASSENET** *(journaliste — noir — le dossier fermé sur la table, la main dessus)*
...
**MASSENET** *(journaliste — sourire — il pousse une enveloppe fermée vers toi, il garde la main dessus)*
...
**Retrouvailles** — `co.retrouvailles.meneche_sourire` (≥ +2) : Massenet, micro éteint posé sur la table : « Nouveau costume, {toi}. Juste une question, hors micro : je vous appelle comment, maintenant ? » — un bouton **Comme avant** — effets : tribunes +, relation.meneche +1 — *Il t'appelle comme avant. À l'antenne, il dit le titre.* · `co.retrouvailles.meneche_noir` (≤ −2) : Massenet, micro allumé : « Nouveau costume, même dossier. Juste une question, micro : vous avez lu ce que j'ai écrit sur {nom} ? » — un bouton **J'ai lu** — effets : tribunes −, direction − — *Ton nouveau patron aussi. Il a corné la page.*

---

## JEAN-MARIE VAUBOURG  (`aulard`)
**Fonction** : président de {club} (1990-1998), président de la Ligue (1998-2008), président de la Fédération (2008-2016) · **Genre** : m · **Âge en 1990** : 58 · **Camp** : direction (bande `instances` de 2008 à 2016) · **Fenêtre** : 1990-2016, puis `retraite` (il téléphone à 23 h 47, il vient au Congrès en spectateur, il te « rappelle » encore) ; meurt en 2020, dans son bureau, un empire et pas le temps · **Suivant** : « le fils de Vaubourg » (voix ; ch. 11 `en.fils_aulard`), qui ne veut pas de l'empire ; Malbec à la Ligue
...
**VAUBOURG** *(président — noir — il fait glisser un chèque, signé, sans date)*
...
**Traces** : cheque_non_date · **Réactions déclenchées** : en.re.josiane_cheque (∃, entraîneur, si `relation.josiane >= 0`) · **Lu plus tard par** : en_sms et en_placard (epitaph_plus, ch. 30), in.congres variante « le bloc Vaubourg vote contre » (ch. 15), une.generic.cheque_non_date (ch. 20), co.nemesis.aulard (ch. 90)
...
**VAUBOURG** *(président — sourire — il ne dit pas bonjour, il ne dit jamais bonjour)*
...
**Traces** : aulard_rappelle · **Réactions déclenchées** : — · **Lu plus tard par** : Porte de sortie variante « l'offre de Vaubourg, un cran en dessous » (ch. 30), bilan_carrefour variante « le bureau chez Vaubourg » (ch. 30), en.aulard_rappelle (ch. 11, `if: flag('aulard_rappelle')` : poids ×2), pr.president_ami variante (ch. 13, lit aussi `president_ami`)

**Retrouvailles** — `co.retrouvailles.aulard_sourire` (≥ +2) : Vaubourg, un cigare qu'il n'allume pas : « Nouveau fauteuil, {toi} ; je l'ai eu avant vous, il grince. J'ai pas le temps, j'ai un empire, mais j'ai une minute. » — un bouton **Une minute, alors** — effets : direction +, relation.aulard +1 — *Une minute. Il en prend douze.* · `co.retrouvailles.aulard_noir` (≤ −2) : Vaubourg, sans se retourner : « Le fauteuil de {nom}, on me l'a décrit. J'ai pas le temps, j'ai un empire ; j'ai un vote aussi. » — un bouton **Je m'en souviendrai** — effets : direction −, relation.aulard −1 — *Lui aussi. C'est son métier.*

---

## MADAME JOSIANE  (`josiane`)
**Fonction** : secrétaire du club depuis 1987 ; de la Fédération (2008-2016) ; de la FédéMonde (2016-2022) · **Genre** : f · **Âge en 1990** : 52 · **Camp** : direction (bande `instances` de 2008 à 2022) · **Fenêtre** : 1990-2022, puis `retraite` (elle range encore les dossiers ; elle téléphone pour dire qu'un fax est arrivé, alors qu'il n'y a plus de fax) ; **fenêtre exceptionnelle assumée** : elle est en poste à quatre-vingt-quatre ans, et c'est la blague du personnage — le Congrès de 2024 lui votera la seule dérogation d'âge qu'il ait jamais accordée, à main levée, et à quelqu'un qui était déjà partie (`derogation_age`) ; meurt en 2030, on trouve le classeur rangé · **Suivant** : « la petite Josiane », sa nièce, au club (voix sans portrait) ; à la Fédération, Dauzat garde les procès-verbaux, elle gardait les gens
...
## CHEIKH ILYAS  (`nassir`)
**Fonction** : le fonds Almadis : sponsor, puis propriétaire ; rachète Capitale FC (2007) ; comité du Mondial (2010-2030) ; président de la Ligue (2028-2040) · **Genre** : m · **Âge en 1990** : 34 · **Camp** : direction · **Fenêtre** : 1990-2045, puis `retraite` (il regarde les matchs d'Al-Dorado FC seul, dans une loge vide) · **Suivant** : « un émissaire d'Almadis » (voix), puis « le neveu de l'émir » (voix, 2030)
...
**Trajectoire** : 1990 la canette orange, le maillot · 2000 les écus, le prêt à 51 %, Arena Almadis · 2007 Capitale FC ; 2010-2030 le Mondial d'Al-Dorado, en hiver · 2020 le club frère de l'autre hémisphère, la multi-propriété · 2028 il préside la Ligue, « la Ligue est un actif » · 2040 la loi des franchises est sa loi ; 2045 la loge vide
...
**ILYAS** *(fonds — noir — ce n'est pas lui : c'est une notification, il n'a pas signé)*
...
**ILYAS** *(fonds — sourire — sans canette, sans émissaire, sans téléphone)*
...
**Rôle** : entraineur | ds | president · **Intrigue** : palier (`on_relation` −3) · **Étape** : palier −3 · **Moment** : [1,3] cartes après le franchissement, une fois par carrière · **Lieu** : le bureau, un contrat posé à l'envers · **Conditions** : relation.solvang <= -3 ; `statut_ok: [club, rival]` ; year >= 1995 (`monde_libre_1993`), sinon variante `_clause` (« la clause, au centime »)
...
**Désir** : trouver le dernier grand · **Blessure** : celui qu'il a raté : un gardien de Néville qui avait dix-sept ans en 1966, dit la légende, et qui s'appelait Vecchio ; Barbier avait trente-quatre ans, c'était son deuxième rapport
...
**Fonction** : président du Racing de Valentienne (1990-2008), président de la Ligue (2008-2012), candidat à la Fédération (2016) · **Genre** : m · **Âge en 1990** : 54 · **Camp** : direction (bande `instances` de 2008 à 2020) · **Fenêtre** : 1990-2016 (Valentienne jusqu'en 2008, la Ligue jusqu'en 2012 à soixante-seize ans, puis quatre ans de candidature et une défaite), puis `retraite` (il siège au Congrès comme président d'honneur, il compte les voix des autres) ; meurt en 2024 · **Suivant** : Bréhaut à la Ligue (2020), puis Ilyas (2028) ; à Valentienne, « le fils Malbec » (voix)
...
**Désir** : la Ligue, puis la Fédération, sans passer par les districts · **Blessure** : Vaubourg lui a pris un entraîneur (1994) et une élection (2008) ; il a gardé les deux lettres
...
**Ce qu'il pense de toi** : à +2 tu es un président avec qui l'on se comprend · à 0 tu es une voix · à −2 tu es la créature de Vaubourg, même si tu ne l'as jamais rencontré
...
**Trajectoire** : 1990 la tribune la plus froide du pays, un président qui ne l'est pas · 1998 Vaubourg prend la Ligue ; il attend dix ans · 2008 la Ligue ; il perd la Fédération contre Vaubourg, il garde la lettre · 2016 candidat contre toi ou élu par défaut · 2020 président d'honneur ; il compte à voix haute · 2033 l'enterrement ; Vaubourg est déjà mort, il a gagné ça
...
**Traces** : voix_malbec · **Réactions déclenchées** : — · **Lu plus tard par** : Carte Destin président pro → Fédération (ch. 30 : « trois alliés » ; `voix_malbec` en compte deux), in.election variante « le Nord vote » (ch. 15), pr.president_ami variante (ch. 13, lit `president_ami` : « Vaubourg ou Malbec, il faut choisir »), une.quotidien.le_nord_a_vote (ch. 20)
...
**Fonction** : président du Castel Montoya (Castellane), le géant qui a tout gagné et perd de l'argent ; le patron des quatorze · **Genre** : m · **Âge en 1990** : 60 · **Camp** : direction · **Fenêtre** : 1990-2021 ; il meurt en 2021, à quatre-vingt-onze ans, à la table, pendant un vote qu'il gagnait — c'est la blague du personnage, et la seule fenêtre du casting qui dépasse soixante-quinze ans sans s'excuser · **Suivant** : « le fils de Montoya » (voix), qui reprend « la table » et y ajoute une chaise
**Tic** : « Quatorze clubs. Une table. Vous êtes assis ou debout ? » — torsions : « Onze clubs. Une table. Il manque une chaise. » · « Vous étiez assis. Vous êtes debout. » · « Une table. Douze chaises. Aucun club. » (2019, les 60 heures)
...
**Dans les rôles** : joueur : le transfert du siècle, un pont (0,5) · entraîneur : le Castel Montoya t'appelle à mi-saison, la veille d'un derby (0,5) · **président : « Assis ou debout ? » ; les 60 heures ; s'il lit `ligue_fermee_signee`, tu es assis, et il te le rappelle à chaque Nouvelle de mépris** (1) · **instance : le bloc des quatorze contre l'Union ; à l'hôtel du Lac il a une suite, tu as une chambre** (1)
**Trajectoire** : 1990 quatorze clubs, une idée · 2000 les droits, la Coupe Continentale trop petite pour lui · 2010 la multi-propriété, le club frère · 2019 les 60 heures ; six clubs tiennent, ou aucun · 2027 il meurt à la table, en votant ; son fils prend la chaise encore chaude · 2040 la loi des franchises est sa table, sans lui
**Retrouvailles** : `co.retrouvailles.montoya_sourire` / `_noir` (le fils, après 2027)
**Cartes propres** : *Le transfert du siècle* (ch. 10) · *Le Castel appelle* (ch. 11) · *Les 60 heures* (ch. 13, huit scènes de six heures) · *Le bloc des quatorze* (ch. 15) · *Assis ou debout ?* (ch. 30, Carte Destin président → Union) · *Le vote de trop* (ch. 31, 2027) · *Debout* (ci-dessous)
...
**Traces** : exclu_de_la_table · **Réactions déclenchées** : — · **Lu plus tard par** : pr.ligue_fermee cartes de mépris variante « tu n'étais même pas à la table » (ch. 13, lit `ligue_fermee_signee`), in.bloc_des_quatorze variante (ch. 15), une.quotidien.debout (ch. 20), pr_siege (epitaph_plus, ch. 30)
...
« Quatorze clubs, une table, et la chaise à ma droite est à vous, {toi} : elle mène à l'Union sans passer par les districts. Assis ? »
...
**Traces** : chaise_montoya · **Réactions déclenchées** : co.re.gege_decoupe (∃, ← seulement) · **Lu plus tard par** : Carte Destin président pro → Union Continentale « la voie ligue fermée » (ch. 30 : `chaise_montoya` remplace « Montoya à +2 »), in.bloc_des_quatorze variante « tu as une chaise » (ch. 15), pr.ligue_fermee heure 1 variante (ch. 13), une.gazette.la_chaise (ch. 20)

**Retrouvailles** — `co.retrouvailles.montoya_sourire` (≥ +2 ; après 2027, « le fils de Montoya » lit la même réplique avec « mon père disait ») : Montoya, sans se lever : « Nouveau titre, ami, même table. Quatorze clubs, une table : votre chaise a suivi. » — un bouton **Je m'assieds** — effets : direction +, relation.montoya +1 — *La chaise a suivi. Elle est un peu plus loin du centre.* · `co.retrouvailles.montoya_noir` (≤ −2) : Montoya, par un émissaire : « Don Alvaro a appris pour {nom}. Il fait dire : quatorze clubs, une table, et toujours pas de chaise. » — un bouton **Dites-lui que je suis debout** — effets : direction − — *Il le sait. Il a fait retirer la chaise du couloir aussi.*

---

## DUPUIS  (`dupuis`)
**Fonction** : boucher, sponsor du club de village ; « Arena Dupuis » (2015, fortune faite dans les surgelés) · **Genre** : m · **Âge en 1990** : 50 · **Camp** : direction · **Fenêtre** : 1990-2020, puis `retraite` (il vient au stade avec son tablier, par habitude) ; meurt en 2026 · **Suivant** : « le fils de Dupuis » (voix), qui ne voulait pas reprendre la boucherie et qui reprend les surgelés
...
**Fonction** : maire d'Aubérive (1990-1997), députée (1997-2002), ministre des Sports (2002-2012), puis présidente de région (2012-2022) · **Genre** : f · **Âge en 1990** : 46 · **Camp** : instances · **Fenêtre** : 1990-2022 (elle s'arrête à soixante-dix-huit ans, deux mandats de trop, elle le dit elle-même), puis `retraite` (elle inaugure encore, sans ruban) ; meurt en 2035 · **Suivant** : « le nouveau maire » (voix), qui veut son fils à lui dans l'équipe ; « le ministre », sans nom, après 2012
...
## NOÉ BERTHOMIER  (`legruet`)
**Fonction** : président de la Fédération (1988-2008), président de l'Union Continentale (2008-2016) · **Genre** : m · **Âge en 1990** : 63 · **Camp** : instances · **Fenêtre** : 1990-2016, puis `retraite` (il vient au Congrès, il « verra ça après ») ; meurt en 2029 ; l'enterrement est un Congrès · **Suivant** : Vaubourg (2008), puis toi ; à l'Union, « le dauphin »
...
**Trajectoire** : 1990 la Fédération, les districts, sept voix · 2000 réélu de neuf ; le Mondial 1998 est « le sien » · 2008 l'Union, de neuf voix encore ; Vaubourg prend la Fédération · 2016 la retraite ; il vient au Congrès en spectateur, on le laisse parler · 2029 l'enterrement ; trois cents districts, une voix chacun · L'Almanach : « {annee} : Berthomier est mort. On verra ça après le Congrès. »
...
**Rôle** : entraineur | selectionneur | instance | joueur · **Intrigue** : palier (`on_relation` −3) · **Étape** : palier −3 · **Moment** : [1,3] cartes après le franchissement, une fois par carrière · **Lieu** : la télé du couloir ; Vence parle, Berthomier est à côté d'elle · **Conditions** : relation.legruet <= -3 ; `statut_ok: [club, retraite]` ; variante `_joueur` si role == 'joueur' (« il n'est pas dans la liste, et il l'apprend avec vous »)
**BERTHOMIER** *(Fédération — noir — à l'écran, il regarde la caméra, pas toi)*
...
**BERTHOMIER** *(Fédération — sourire — il te prend le bras, il ne le fait jamais)*
...
**Dans les rôles** : président : les 60 heures ; il « est choqué » par la Ligue fermée et signe le communiqué depuis un yacht qui n'est pas le sien (0,5) · sélectionneur : il remet le trophée à côté d'un dictateur ; il te serre la main deux fois pour la photo (0,5) · **instance : le patron (Union : il te tient), le rival (FédéMonde : tu le remplaces), le parrain (il te fait élire et te le rappelle) ; à 79 ans il se représente, contre toi si tu es là** (2)
**Trajectoire** : 1990 le Mondial de 1994, les milliards, le costume · 2000 le Mondial de 2002, « le football unit le monde » gravé dans le hall · 2010 l'attribution du désert (`mondial_desert`), les 48 équipes votées (2015, sans lui, mais c'est son idée) · 2011 se représente à 79 ans · 2016 il « se retire » ; le comité d'éthique le suspend pour « un virement entre amis » (2017) · 2024 l'enterrement, à l'hôtel du Lac ; Amsel est là, à l'heure
**Retrouvailles** : `co.retrouvailles.bambini_sourire` / `_noir`
**Cartes propres** : *Le trophée à côté du dictateur* (ch. 14, temps fort) · *Choqué* (ch. 13, les 60 heures) · *Se représenter à 79 ans* (ch. 15) · *L'ancienne gloire au comité* (ch. 30, Carte Destin sélectionneur → Union) · *Le Parrain* (ch. 30, Destin) · *Mes amis* (ci-dessous)
...
**Fonction** : secrétaire général de la Fédération (1990-2012), de l'Union (2012-2020), de la FédéMonde (2020-2024) · **Genre** : m · **Âge en 1990** : 44 · **Camp** : instances · **Fenêtre** : 1990-2024, puis `retraite` (il garde les procès-verbaux chez lui, dans l'ordre) ; meurt en 2036, le dernier PV signé de sa main · **Suivant** : « le secrétaire général » (voix), sans nom, dès 2032 ; Josiane tenait les gens, lui tient les pages
...
**Trajectoire** : 1990 le procès-verbal du Congrès, à la main · 2000 il numérote les pages, il ajoute la page 41 · 2008 Vaubourg le garde ; il garde Vaubourg · 2012 l'Union : il apprend une langue de plus, celle des valises · 2020 la FédéMonde ; Amsel lui demande les PV, il les donne dans l'ordre · 2032 la retraite ; 2044 mort ; l'Almanach : « {annee} : Dauzat n'est plus dans le procès-verbal. »
...
**Fonction** : l'Inspecteur de la Commission de Contrôle des Comptes (1989-2020) ; consultée une fois, en 2033, quand la Commission devient une agence de notation qu'elle refuse de diriger (« je ne juge pas, je compte, et une note est un jugement ») · **Genre** : f · **Âge en 1990** : 45 · **Camp** : instances · **Fenêtre** : 1990-2020 (elle part à soixante-quinze ans, le jour du vote de la limite d'âge, sans rien dire), puis `retraite` (elle compte les recettes de la buvette de Trébignac, bénévole, à la ligne) ; meurt en 2032 · **Suivant** : « l'algorithme de notation » (voix), qui ne laisse rien passer et ne comprend rien
...
## JUDITH AMSEL  (`amsel`)
**Fonction** : procureure ; les paris, les valises, les écoutes, l'hôtel du Lac · **Genre** : f · **Âge en 1990** : 47 · **Camp** : instances · **Fenêtre** : 1990-2028, puis `retraite` (elle écrit un livre sans nom dedans ; La Plume le commente) ; meurt en 2030 · **Suivant** : « la brigade » (voix), puis « la procureure suivante », qui frappe à sept heures : Amsel disait que c'était trop tard
...
## FIRMIN ROUX  (`roux`)
**Fonction** : président du district (1990-2002) · **Genre** : m · **Âge en 1990** : 66 · **Camp** : instances · **Fenêtre** : 1990-2002 (il passe la main à soixante-dix-huit ans, à son fils, en jurant que c'est le district qui a choisi), puis `retraite` (il vient au Congrès jusqu'en 2012 avec sa carte de délégué, périmée, qu'on accepte : c'est sa blague, et personne n'ose la lui retirer) ; meurt en 2014 ; trois cents districts envoient une couronne chacun · **Suivant** : « le fils de Roux » (voix), délégué dès 2012, qui vote comme son père votait
**Tic** : « Le district, c'est la base. » — torsions : « La base, c'est le district. Le sommet, c'est loin. » · « Le district, c'est la base. La base a voté. » · « Sans le district, pas de base. Sans base, pas de Berthomier. »
**Désir** : être invité à la table de Berthomier · **Blessure** : Berthomier ne retient jamais son prénom ; en 1992, il a battu Dauzat pour le district et Berthomier a félicité « Fernand »
...
**Trajectoire** : 1990 le district, la commission, le samedi matin · 1992 il bat Dauzat ; Berthomier dit « Fernand » · 2000 la Coupe : il exige que Trébignac joue « à domicile, dans la boue » · 2008 il vote Vaubourg contre Malbec « parce qu'Vaubourg a dit mon prénom » · 2012 le fils ; la retraite ; 2014 l'enterrement, trois cents couronnes ; Berthomier dit « Firmin », enfin
...
**Traces** : huis_clos · **Réactions déclenchées** : — · **Lu plus tard par** : pa_club_a_cote (epitaph_plus « le district avait fermé le stade », ch. 30), pr.buvette variante « trois matchs sans recette » (ch. 13, lit aussi `gerard_parti`), une.echo.huis_clos (ch. 20), in.election variante « le district de Roux vote contre » (ch. 15)

### SCÈNE co.roux.faveur_siege  —  Le siège
**Rôle** : president_amateur | instance · **Intrigue** : palier (`on_relation` +3) · **Étape** : palier +3 · **Moment** : [1,3] cartes après le franchissement, une fois par carrière · **Lieu** : la buvette du district, après la commission ; il t'a gardé une chaise · **Conditions** : relation.roux >= 3 ; `statut_ok: [club, retraite]` ; variante `_legruet` si `flag('districts_legruet')` (« Berthomier a parlé, mais c'est moi qui décide »)
...
**Fonction** : sélectionneur des Cobalts (1986-1994), puis consultant de Télé-Stade (1995-2015), « le plateau du dimanche » avant Massenet et à côté de lui · **Genre** : m · **Âge en 1990** : 52 · **Camp** : selection (bande `direction` dès 1995 : il commente) · **Fenêtre** : 1990-2015, puis `retraite` (il vient aux matchs des Cobalts en tribune de presse, sans micro, à côté de Vence retraitée ; il téléphone à ses successeurs la veille des listes) ; meurt en 2022, pendant le Mondial d'hiver de 2030, devant une séance de tirs au but · **Suivant** : « le sélectionneur de 2002 » (voix sans portrait : celui qui gagne à six mille kilomètres avec sept joueurs lancés par Rossard, si tu n'y es pas), puis toi ; au plateau, Massenet (2003), puis Dembo consultant (2010)
...
**Désir** : qu'on lui rende 2002 : que quelqu'un dise à voix haute que sept des vingt-trois venaient de son cahier · **Blessure** : la finale de 1990 perdue aux tirs au but, les larmes en direct devant Vence, le Mondial de 1994 raté, le limogeage par Nouvelle ; puis son successeur a gagné en 2002 avec sept joueurs qu'il avait lancés, et personne n'a prononcé son nom ce soir-là
...
Variante `_joueur` : « Le {numero} n'est pas dans ma liste, et je le dis ici avant de le lui dire : il n'a pas le niveau, pas encore. Moi, à sa place, je travaillerais. » — ← **Je travaillerai** — effets : vestiaire +, tribunes −, set: remplacant_nomme — *Tu travailles. La liste suivante est celle d'un autre sélectionneur.* → **Il ne me verra plus** — effets : tribunes +, direction −, set: remplacant_nomme, set: selection_refusee — *Il ne te voit plus. Berthomier non plus : c'est le règlement des forfaits.*
**Traces** : remplacant_nomme (et `selection_refusee` à droite de la variante joueur) · **Réactions déclenchées** : co.re.vence_direct (§ 6) · **Lu plus tard par** : sl.tournoi variante « le groupe connaît le nom du suivant » (ch. 14), sl_minuit (epitaph_plus « Rossard avait donné le nom », ch. 30), une.quotidien.le_nom_du_suivant (ch. 20), co.legruet.trahison_avant_toi (variante « Rossard l'a dit avant Berthomier »), co.fantome.consultant (ch. 90)
...
« Les vingt-trois de quatre-vingt-seize, comment on les tenait, ce qu'on leur disait la veille du Grand Stade ; c'est mon groupe, et je vous le donne. Moi, à votre place, j'y étais. »
...
→ **Gardez-le pour le Congrès** — effets : tribunes +, parole +1, set: cahier_rossard, set: rossard_honore — *Il le garde. Il dit au Congrès que quatre-vingt-seize était à lui, et la salle applaudit sans se lever.*
**Traces** : cahier_rossard (et `rossard_honore` à droite) · **Réactions déclenchées** : — · **Lu plus tard par** : sl.liste variante « le cahier de Rossard » (ch. 14 : la carte Liste lit `cahier_rossard`), co.rossard.planche_quatre_vingt_seize (§ 5), co.fauvel_liste variante « entouré deux fois » (ch. 01), une.quotidien.le_cahier_de_rossard (ch. 20), sl_fete (epitaph_plus « le cahier de Rossard était dans le bus », ch. 30)

**Retrouvailles** — `co.retrouvailles.rossard_sourire` (≥ +2, `statut_ok: [club, staff, retraite]`) : Rossard, au téléphone, la télé allumée derrière : « Nouveau poste, petit, et je suis à l'antenne dimanche : je dirai du bien, ce qui ne m'arrive pas. Moi, à votre place, je regarderais. » — un bouton **Je regarderai** — effets : tribunes +, relation.rossard +1 — *Il dit du bien. Massenet, à côté, s'étonne en direct.* · `co.retrouvailles.rossard_noir` (≤ −2) : Rossard, sur le plateau, sans te nommer : « Un nouveau visage à ce poste, et je l'ai déjà vu perdre : il n'était pas dans ma liste de 1992, et il n'y a pas manqué. Moi, à sa place, je l'aurais fait. » — un bouton **Il n'oublie rien** — effets : tribunes −, direction − — *Il n'oublie rien. La régie ressort l'image de 1992 ; tu n'y es pas.*
...
**Issues** → **Traces** → **Qui les lit** : `dit_hors_micro` → `hors_micro_dit` (« {annee} : {nom} a parlé hors micro à Massenet. Massenet a un carnet. ») → étape 2, ch. 11 (le dossier Massenet, variante « votre propre phrase »), ch. 20 · `rien_hors_micro` → [hors_micro_rien] → étape 2 (il cite quelqu'un d'autre) · `compo_donnee` → `compo_meneche` (« {annee} : Massenet avait la compo avant le vestiaire. Un proche la lui donnait. ») → ch. 11 (en.kop variante « la compo est dans le journal »), ch. 01 (Bréhaut : « le groupe a lu »), ch. 20 · `promis_en_direct` → `promesse_plateau` (« {annee} : {nom} a promis en direct, chez Massenet. ») → ch. 30 (set-piece `bilan_verdict` : « tu l'avais dit au Plateau »), ch. 20 (« Les promesses, datées »), ch. 14 · `chapitre_relu` / `chapitre_brut` → `chapitre_meneche` (« {annee} : Massenet a publié un chapitre au nom de {nom}. Relu, ou pas. ») → ch. 31 (Nouvelle 2025), ch. 90 (Fantôme consultant), ch. 20
...
**Scènes** : 4
**Épilogue** : par abandon, la phrase hors micro reste dans le carnet ; l'Almanach écrit « {annee} : Massenet a une phrase de {nom} en réserve. » ; `hors_micro_dit` reste lisible par ch. 11.
...
**MASSENET** *(journaliste — neutre — il ferme son carnet pour montrer qu'il le ferme)*
...
**MASSENET** *(journaliste — neutre — il te tend le journal ouvert, une phrase entourée au stylo rouge)*
...
**Rôle** : president | selectionneur · **Intrigue** : co.meneche_hors_micro · **Étape** : 3/4 · **Moment** : saison 2 ou plus, year >= 2003, créneaux [10,15] · **Lieu** : le Plateau de Télé-Stade ; Massenet au centre, Rossard à sa droite, le voyant rouge · **Conditions** : `chars.meneche.statut == club` ; variante `_selectionneur` si role == 'selectionneur' (« vous gardez le capitaine ? » ; Rossard souffle « moi, à sa place »)
**MASSENET** *(consultant — neutre — il ne dit plus « hors micro » : il montre le micro)*
...
**MASSENET** *(retraité — neutre — au téléphone ; on entend une machine à écrire, il n'a jamais changé)*
...
**Issues** → **Traces** → **Qui les lit** : `projet_signe` → `projet_aulard` (« {annee} : {nom} a signé le projet de Vaubourg. Deux ans, une case. ») → ch. 30 (set-piece `objective` variante « le projet dit deux ans »), ch. 11 (`en.promu` A2 variante), ch. 20 · `fils_case` → `fils_aulard_staff` (« {annee} : le fils de Vaubourg a une case dans le staff de {nom}. Il ne la voulait pas. ») → ch. 11 (en.fils_aulard variante « il est déjà chez toi »), ch. 01 (Vukić : « il dîne avec le fils »), ch. 20 · `vote_gros` / `vote_petits` → `vote_gros` (« {annee} : {nom} a voté les droits télé avec les gros. Vaubourg a compté. ») / `vote_petits` (« {annee} : {nom} a voté avec les petits. Malbec a noté. ») → ch. 13 (pr.droits_tele), ch. 15 (le bloc Vaubourg au Congrès), co.malbec.lettres_candidat (§ 5), ch. 20 · `tiroirs_ouverts` / `tiroirs_fermes` → `tiroirs_aulard` (« {annee} : {nom} a ouvert les tiroirs de Vaubourg. Des brouillons, des fautes. ») → ch. 15 (`heritage_empoisonne` : « le prédécesseur a laissé des tiroirs »), ch. 30 (in_showman plus), co.retrouvailles.aulard_noir, ch. 20
...
**Scènes** : 4
**Épilogue** : par abandon, l'organigramme reste au mur du bureau avec ta case barrée ; l'Almanach écrit « {annee} : la case de {nom} dans l'organigramme de Vaubourg est barrée. Au feutre. »
...
**VAUBOURG** *(président — neutre — il écrit ton nom dans la case au feutre, en majuscules, sans te demander l'orthographe)*
...
**VAUBOURG** *(président — neutre — il parle bas, ce qui ne lui arrive jamais)*
...
**VAUBOURG** *(président de la Ligue — neutre — il te dit « cher collègue » pour la première fois, et il écoute comment ça sonne)*
...
→ **Je vote avec les petits** — effets : caisse −, tribunes +, set: vote_petits, relation.malbec +1, relation.aulard −1 — *Les petits perdent quand même. Vaubourg te sourit : il aime savoir où tu es assis.*
**Traces** : vote_gros, vote_petits · **Réactions déclenchées** : co.re.malbec_compris (§ 6) · **Lu plus tard par** : pr.droits_tele (ch. 13 : la répartition lit `vote_gros`), in.congres variante « le bloc Vaubourg se souvient de ta voix » (ch. 15, lit aussi `president_ami`), co.malbec.lettres_candidat (§ 5 : « vous aviez voté avec lui »), une.quotidien.les_gros_ou_les_petits (ch. 20)
...
« Les tiroirs de monsieur Vaubourg, des brouillons de SMS avec des fautes, dont le vôtre. J'en ai vu passer, vous savez ; ceux-là, personne ne les a lus. »
← **Je les publie** — effets : tribunes ++, direction −−, parole +1, set: tiroirs_aulard, set: tiroirs_ouverts — *La Gazette titre sur les fautes. Vaubourg, à la retraite, tweete à 3 h que c'était de l'autocorrection.*
...
→ **Aux archives, tout** — effets : direction +, parole +1, relation.dauzat +1 — *Dauzat la classe. Elle est entre celles de Vaubourg et de Berthomier ; il l'a fait exprès, il dit que non.*
...
**Scènes** : 4
**Épilogue** : par abandon, l'émissaire envoie une lettre : « le fonds a révisé ses positions » ; l'Almanach écrit « {annee} : Almadis a révisé ses positions sur {nom}. Par courrier. »
...
**ILYAS** *(fonds — neutre — il ne touche pas à la canette : elle est là pour la photo qu'on ne prend pas)*
...
**ILYAS** *(fonds — neutre — un émissaire lui tend une feuille, il ne la lit pas, il la connaît)*
...
**ILYAS** *(fonds — neutre — un document d'une page, un chiffre : trente)*
...
**ILYAS** *(président de la Ligue — neutre — il compte les mains levées avec le stylo, sans regarder les visages)*
...
← **J'écoute** — effets : direction −−, caisse +, set: malbec_ecoute — *Tu écoutes vingt minutes. Vaubourg le sait à 23 h 46 ; il t'envoie un SMS, sans faute, c'est mauvais signe.*
...
**Logline** : Don Alvaro Montoya te propose une chaise à chaque rôle, et son fils reprend la table quand il meurt dessus. · **Synopsis** : Joueur, le transfert du siècle et un pont pour le passer. Entraîneur, il t'appelle la veille du derby : le Castel a besoin d'un míster mardi. Président, le premier dîner des quatorze, et une chaise que Gégé photographiera. Dirigeant, après 2027, le fils vient demander à l'Union une chaise pour la Ligue fermée, avec la même phrase que le père.
**Rôle(s)** : joueur, entraineur, president, instance · **Postulat(s)** : partagé (`pepite`, `banc_dore`, `six_mois`, `rachete_fonds`, `tournoi_desert`, `elu_surprise`) · **Porteur** : montoya · **Cast** : Montoya, « le fils de Montoya » (voix), Gégé (nommé), Bambini (nommé), Ilyas (nommé) · **Thème** : instances
**Saisons** : "0" (étape 1), "1" (étape 2), "2+" (étapes 3-4) · **Conditions d'entrée** : `chars.montoya.statut in [club, rival]` ; étape 3 : year >= 2010 ; étape 4 : year >= 2027 · **Exclusions** : étape 3 jamais la même saison que la chaîne des 60 heures (ch. 13) · **Rejouabilité** : jamais
**Issues** → **Traces** → **Qui les lit** : `transfert_siecle` / `reste` → `transfert_siecle` (« {annee} : {nom} au Castel Montoya. Le transfert du siècle, et un pont. ») → ch. 10 (le club change de pays : Castellane), ch. 90 (mémoire du club quitté), ch. 20 (« LE PONT ») · `derby_abandonne` / `derby_dabord` → `derby_abandonne` (« {annee} : {nom} a pris l'avion la veille du derby. Le Castel appelait. ») → ch. 11 (co.derby : le derby se joue sans toi), ch. 01 (Gégé : « la tribune n'oublie rien »), ch. 20 · `assis_diner` / `debout_diner` → `assis_diner` (« {annee} : {nom} a dîné à la table des quatorze. Assis. ») → ch. 13 (la chaîne des 60 heures commence à l'heure 1 avec une chaise), co.montoya.faveur_assis (ne se déclenche pas si posée : la chaise est déjà tirée), ch. 20 · `chaise_fils` / `fils_debout` → `fils_montoya_chaise` (« {annee} : le fils de Montoya a eu une chaise à l'Union. {nom} l'a tirée. ») → ch. 15 (in.bloc_des_quatorze après 2027), ch. 30 (fin *La Ligue fermée* plus), ch. 20
...
**MONTOYA** *(président du Castel — neutre — il te montre une chaise vide de la main ; il ne se lève pas)*
« Le Castel paie ce que votre club demande et le double de ce que vous gagnez ; c'est le transfert du siècle, chico, et le pont pour le passer. Quatorze clubs, une table : vous êtes assis ou debout ? »
...
**Traces** : transfert_siecle · **Réactions déclenchées** : co.re.gege_decoupe (∃, ←) · **Lu plus tard par** : jp.mercato (ch. 10 : le club devient le Castel Montoya, Castellane), co.memoire_clubs (ch. 90 : « le transfert du siècle » à −1 chez le club quitté), une.gazette.le_pont (ch. 20), co.montoya.table_diner (« vous avez déjà été assis chez moi »)
...
**MONTOYA** *(président du Castel — neutre — il ne demande pas si tu es libre : il dit l'heure du vol)*
« Le Castel a besoin d'un míster mardi et l'avion part demain à dix heures, pendant votre derby ; on ne vous le proposera pas deux fois. Quatorze clubs, une table : assis ou debout ? »
...
→ **Après le derby** — effets : parole +1, tribunes +, set: derby_dabord, relation.montoya −1 — *Tu restes. Le Castel prend Vogler mardi. Le derby, tu le perds ou tu le gagnes, mais tu y es.*
**Traces** : derby_abandonne, [derby_dabord] · **Réactions déclenchées** : co.re.gege_decoupe (∃, ←) · **Lu plus tard par** : co.derby variante « le coach est parti la veille » (ch. 11, pose aussi `derby_perdu` par forfait de banc), co.gege_virage (ch. 01 : « la tribune n'oublie rien, surtout la veille »), co.klopf_pressing variante « le Castel l'a pris à ta place » (ch. 01), une.gazette.lavion_de_dix_heures (ch. 20)
...
**MONTOYA** *(président du Castel — neutre — il fait signe au serveur d'apporter le douzième carton, vierge, avec un stylo)*
« Onze présidents dînent ici une fois par an, et la douzième chaise n'a pas de carton depuis trois ans ; écrivez votre nom, ou ne l'écrivez pas. Quatorze clubs, une table. »
...
→ **Je dîne debout, au bar** — effets : tribunes +, direction −, set: debout_diner — *Tu dînes au bar. Ilyas vient te parler ; il n'est pas assis non plus, il possède le restaurant.*
**Traces** : assis_diner, [debout_diner] · **Réactions déclenchées** : co.re.gege_decoupe (∃, ← : il découpe la photo et entoure la chaise) · **Lu plus tard par** : pr.ligue_fermee heure 1 (ch. 13 : `assis_diner` = tu es à la table quand ça commence), co.montoya.faveur_assis (ne se déclenche pas si `assis_diner`), in.bloc_des_quatorze (ch. 15), une.gazette.la_douzieme_chaise (ch. 20)

### SCÈNE co.montoya.table_fils  —  Le fils
**Rôle** : instance · **Intrigue** : co.montoya_table · **Étape** : 4/4 · **Moment** : toute saison, year >= 2027, créneaux [8,14] · **Lieu** : ton bureau de l'Union ; le fils a apporté une chaise pliante, il l'ouvre lui-même · **Conditions** : `chars.montoya.statut == parti` (mort en 2021) ; variantes lues dans l'ordre : `flag('exclu_de_la_table')` → « mon père vous avait retiré la chaise ; je vous la rends » ; `flag('chaise_montoya')` → « vous étiez à sa droite ; je suis à sa place » ; `flag('ligue_fermee_signee')` → « vous aviez signé ; l'Union peut signer aussi »
**LE FILS DE MONTOYA** *(voix sans portrait — il a la phrase du père et pas la voix)*
« Mon père est mort à la table en votant, et il m'a laissé la phrase : quatorze clubs, une table ; l'Union a-t-elle une chaise pour la Ligue, ou pas ? Je m'assieds si vous dites oui. »
...
→ **Pas de chaise** — effets : tribunes +, direction +, caisse − — *Il replie la chaise. Il l'emporte ; il reviendra avec, chaque année, c'est sa légende à lui.*
**Traces** : fils_montoya_chaise · **Réactions déclenchées** : — · **Lu plus tard par** : in.bloc_des_quatorze après 2027 (ch. 15 : le bloc a un siège ou non), fin *La Ligue fermée* (epitaph_plus « le fils avait une chaise pliante », ch. 30), co.nv.2027_montoya (ch. 31 : la Nouvelle de sa mort lit la trace l'année suivante), une.quotidien.la_chaise_pliante (ch. 20)
...
**Traces** : naming_signe (∃), arena_dupuis, [dupuis_refuse_arena] · **Réactions déclenchées** : co.re.gege_decoupe (∃, ←) · **Lu plus tard par** : co.nv.2015_arena_dupuis (ch. 31), pr.naming côté bureau (ch. 13 : `arena_dupuis` = le naming est celui de Dupuis, pas d'Almadis), co.gege_virage variante « il ne dit pas le nom » (ch. 01), une.gazette.arena_cochon (ch. 20)
...
« Le stade sera à la ville, vous en serez locataire, et la ville choisit le nom, dans cet ordre. Le stade, c'est de l'argent public ; le loyer aussi, à l'envers. »
...
« Le gouvernement lève la tutelle si un délégué siège au comité, avec voix délibérative ; il a un bureau prêt. Le stade, c'est de l'argent public ; la Fédération aussi. »
...
**Issues** → **Traces** → **Qui les lit** : `liste_acceptee` / `club_dabord` → `international` (∃, posée ici) / `selection_refusee` (∃ § 5.2, posée ici) → ch. 14, ch. 15, co.legruet.trahison_avant_toi, ch. 20 · `derogation_attendue` / `stage_lundi` → `derogation_attendue` (« {annee} : la dérogation de {nom}, à voir après le Congrès. Le Congrès était dans huit mois. ») → ch. 11 (en.diplome : `diplome_arrange` devient possible), ch. 01 (Brissac : « le papier attend le Congrès, pas moi »), ch. 20 · `contrat_blanc` / `minuit_attendu` → `contrat_blanc` (« {annee} : {nom} a signé une prolongation en blanc. Berthomier a rempli. ») / `minuit_attendu` (« {annee} : {nom} a attendu le Congrès. Le contrat finissait à minuit et une. ») → ch. 14 (fin *Minuit et une* : `contrat_blanc` la désarme, `minuit_attendu` la rapproche), co.dauzat.pv_minuit (§ 5), ch. 20 · `liste_publiee` / `liste_gardee` → `liste_districts_publiee` (« {annee} : {nom} a publié la liste des districts de Berthomier. Trois cents subventions, trois cents voix. ») / `liste_districts_gardee` (« {annee} : {nom} a gardé la liste des districts. Et les districts. ») → ch. 15 (`heritage_empoisonne` : question `nettoyer / proteger / oublier`), ch. 30 (Battu au Congrès plus ; in_pantin plus), co.roux.base_prenom (§ 5), ch. 20
...
**BERTHOMIER** *(président de la Fédération — neutre — il dit ton nom comme s'il lisait une liste, parce qu'il lit une liste)*
...
**BERTHOMIER** *(président de la Fédération — neutre — il signe une dérogation de six mois sans lire la date, il la connaît)*
« Six mois de dérogation pour le banc, et le diplôme, on verra ça après le Congrès ; le Congrès est en juin, ça vous laisse une saison. Ne le dites pas à madame Brissac. »
...
→ **Le stage, lundi, chez Corven** — effets : vestiaire −−, direction −, set: diplome, relation.brissac +1 — *Tu pars lundi. Brissac tamponne le papier elle-même ; Berthomier dit qu'il l'avait prévu, après le Congrès.*
...
**Rôle** : selectionneur · **Intrigue** : co.legruet_apres_le_congres · **Étape** : 3/4 · **Moment** : saison 1 ou plus (`at_season +1`), créneaux [13,16], la veille du Congrès · **Lieu** : le couloir de l'hôtel du Congrès ; Dauzat tient le contrat, Berthomier tient le stylo · **Conditions** : `chars.legruet.statut == club` ; year < 2008 ; variante `_dossier` si `flag('fede_dossier')` (« signez en blanc, et le dossier reste dans le tiroir »)
**BERTHOMIER** *(président de la Fédération — neutre — il te tend une feuille avec ta signature à faire et rien au-dessus)*
...
→ **Je signe après le Congrès** — effets : direction −−, parole +1, set: minuit_attendu — *Minuit et une. Le Congrès vote, réélit Berthomier de neuf voix, et « verra » ton contrat en septembre.*
...
### SCÈNE co.legruet.congres_tiroirs  —  Les districts de Berthomier
...
« La liste des districts de Berthomier : trois cents lignes, une subvention, une date, une voix en face. J'en ai vu passer, vous savez ; celle-là, tout le monde la connaît, personne ne l'a vue. »
...
→ **Je garde la liste** — effets : direction ++, parole −1, set: liste_districts_gardee — *Tu gardes. Les districts votent comme avant, pour la même raison ; Berthomier t'appelle pour te féliciter, après le Congrès.*
...
**Logline** : Giancarlo Bambini te remet un trophée à côté d'un dictateur, t'appelle à trois heures pour un communiqué, te demande ta confédération à soixante-dix-neuf ans, et te téléphone quand le comité d'éthique le suspend. · **Synopsis** : Sélectionneur, la finale est gagnée ou perdue : il te serre la main deux fois pour la photo, et le troisième homme sur la photo gouverne un pays qu'on ne nomme pas. Président, les soixante heures de la Ligue fermée : il est choqué, et il faut ta signature sous son communiqué avant l'aube. Dirigeant de l'Union, en 2011, il se représente et compte tes voix. En 2017, retiré, suspendu pour un virement entre amis, il t'appelle : tu présides, ou tu es sur la photo.
...
**Rôle** : president · **Intrigue** : co.bambini_trophee · **Étape** : 2/4 · **Moment** : saison 2 ou plus, year == 2019 ou `flag('monde_ligue_fermee')`, la nuit de la chaîne des 60 heures (ch. 13) · **Lieu** : ton téléphone, trois heures ; on entend un moteur, il est sur un bateau qui n'est pas le sien · **Conditions** : `chars.bambini.statut in [club, retraite]` ; variante `_assis` si `flag('ligue_fermee_signee') || flag('assis_diner')` (« vous étiez à la table ; signez le communiqué, ça vous en sortira »)
...
**Rôle(s)** : entraineur, selectionneur, instance, president · **Postulat(s)** : partagé (`promu`, `interimaire`, `pays_emergent`, `apres_fiasco`, `elu_surprise`, `heritage_empoisonne`, `geant_dechu`) · **Porteur** : dauzat · **Cast** : Dauzat, Amsel, Josiane (nommée), Berthomier (nommé), Roux (nommé) · **Thème** : instances
...
**Rôle(s)** : entraineur, ds, president, instance · **Postulat(s)** : partagé (`promu`, `six_mois`, `vendre_trente`, `coach_intouchable`, `geant_dechu`, `rachete_fonds`, `tournoi_desert`) · **Porteur** : vialat · **Cast** : Vialat, Josiane (nommée), Fardelli (nommé), Vaubourg (nommé), Gérard (nommé) · **Thème** : argent
...
« Trois pour cent versés à un intermédiaire sans nom le douze du mois, et je veux le nom. Je ne juge pas. Je compte, et je ne compte pas les gens sans nom. »
...
« L'agence a noté les trente clubs, de AAA à D, et Trébignac est AAA, buvette comprise. Le conseil veut publier ; je ne juge pas, je compte, et cette note compte : je publie, ou je la garde ? »
...
« Vingt-quatre heures, et une valise dont nous connaissons le trajet, pas le contenu ; nous avons tout notre temps. Expliquez-la, ou taisez-vous : c'est votre droit. »
...
« Un livre sans aucun nom, et le blanc de la page cent douze est le vôtre ; je demande la permission de le remplir. Nous avons tout notre temps ; l'éditeur, moins. »
...
← **Je décroche, et j'écoute** — effets : tribunes +, vestiaire +, set: pichon_appel, relation.pichon +1 — *Tu écoutes vingt minutes. Il te raconte le match mieux que Massenet ; il a tout vu, il a tout compris, il pétrit.*
...
« La Fédération dit que tout le monde est bénévole, et la boîte de Gérard dit autre chose. Le pain, c'est à cinq heures, ça non plus ça ne se déclare pas : tu signes, ou tu déclares tout et on ferme en avril ? »
...
**Rôle** : instance · **Intrigue** : co.roux_la_base · **Étape** : 3/4 · **Moment** : saison 2 ou plus, year >= 2008 && year < 2013, créneaux [13,16] (le Congrès) · **Lieu** : les coulisses de la tribune du Congrès ; il a sa carte de délégué à la main, il la tient comme un ticket · **Conditions** : `chars.roux.statut == club` ; variantes lues dans l'ordre : `flag('liste_districts_gardee')` → « je suis sur la liste de Berthomier, deux fois ; je m'en fiche, je veux le prénom » ; `flag('districts_legruet')` → « Berthomier a dit de voter pour vous ; il n'a pas dit mon prénom » ; sinon neutre
...
→ **Monsieur le président** — effets : direction −, set: firmin_tu, relation.roux −1 — *Tu dis le titre. Il applaudit comme les autres. Le soir, les districts votent comme Berthomier leur a dit, et Berthomier n'a rien dit.*
**Traces** : firmin_dit, firmin_tu · **Réactions déclenchées** : co.re.roux_base (§ 6) · **Lu plus tard par** : in.election (ch. 15 : `firmin_dit` = les districts votent pour toi ; `firmin_tu` = ils votent « comme Berthomier »), co.legruet.faveur_les_districts (variante « Roux a dit que c'était son idée »), anecdote 31.fernand (ch. 31 : la légende du prénom), Battu au Congrès (epitaph_plus « il n'avait pas dit Firmin », ch. 30), une.echo.firmin (ch. 20)
...
← **Je viens, avec une couronne** — effets : tribunes +, direction +, set: couronne_roux — *Tu viens. Trois cent une couronnes ; Berthomier, à quatre-vingt-sept ans, dit « Firmin » devant le cercueil, enfin.*
→ **J'envoie Dauzat** — effets : direction −, tribunes −, set: roux_sans_couronne — *Dauzat y va. Il note au procès-verbal qui était là ; ton nom n'y est pas, et le fils l'a lu.*
...
**Rôle(s)** : joueur, entraineur, selectionneur, instance · **Postulat(s)** : partagé (`pepite`, `fin_de_contrat`, `promu`, `interimaire`, `pays_emergent`, `apres_fiasco`, `heritage_empoisonne`) · **Porteur** : rossard · **Cast** : Rossard, Fauvel, Vence, Massenet (nommé), Berthomier (nommé), « le sélectionneur de 2002 » (voix) · **Thème** : presse
...
**ROSSARD** *(consultant, à l'écran — neutre — il ne te voit pas ; il parle à Massenet, et à trois millions de personnes)*
...
← **Je le nomme conseiller** — effets : tribunes +, direction −, vestiaire −, set: rossard_conseiller, relation.rossard +2 — *Tu le nommes. Il ne découpe plus ; Massenet s'en charge, moins bien. Le groupe se demande pourquoi l'ancien est dans le bus.*
...
### SCÈNE co.rossard.planche_quatre_vingt_seize  —  Quatre-vingt-dix-huit
...
« Le groupe de 2002 est sorti de mon cahier, sept noms sur vingt-trois, et le Congrès peut le dire en une ligne, point douze. Moi, à votre place, je l'aurais fait ; à ma place, je le demande. »
...
**Après** : co.meneche.hors_micro_premiere (les deux), co.meneche.hors_micro_memoires (les deux), co.vence.action_directrice (les deux), co.amsel.temps_livre (les deux), co.rossard.planche_quatre_vingt_seize (les deux) · **Famille** : tiers qui commente · **Conditions** : `chars.lea.statut == club`
...
|---|---|
| `naming_signe` | Ilyas (fiche, retrouvailles « Arena Almadis ») ; Dupuis `faveur_tribune` (variante `_arena`) ; co.dupuis.dos_arena (variante `_qatalyst`, et la pose côté Dupuis) ; co.aubert.public_locataire (variante `_qatalyst`) ; co.nv.2015_arena_dupuis (renvoi ch. 31) |
| `club_actif` | co.nassir.trahison_notification (variante `_proprietaire`) ; co.vialat.trahison_recrutement (variante `_actif`) ; co.nassir.actif_trente_pour_cent (variante `_proprietaire`) ; co.vialat.soldes_jeudi (variante `_actif`) ; fiche Ilyas |
...
| `fede_dossier` | co.josiane.faveur_classeur (variante « la convocation ») ; co.dauzat.trahison_proces_verbal (variante « votre audition ») ; co.legruet.congres_blanc (variante `_dossier`) ; fiche Berthomier ; posée aussi par co.malbec.trahison_denonce, co.colline.trahison_rapport (←) et co.malbec.lettres_non_envoyee (→) |
| `president_ami` | co.aulard.faveur_rappel (renvoi ch. 13) ; co.malbec.faveur_ma_voix (« Vaubourg ou Malbec ») ; co.aulard.empire_tiroirs (variante « votre nom dans la colonne « les miens » ») ; co.aulard.empire_cher_collegue (renvoi ch. 15) |
| `selection_refusee` | fiche Berthomier (joueur : il commence à −1, « on ne dit pas non deux fois ») ; **posée** par co.legruet.congres_liste (→) et co.rossard.trahison_remplacant (variante joueur, →) |
...
| `mondial_desert` | fiche Ilyas (sélectionneur : le calendrier) ; co.nassir.faveur_un_club (renvoi ch. 15) ; co.lea.carnet_la_question (variante « les ouvriers du chantier ») ; co.nassir.actif_club_frere (renvoi ch. 13) |
...
| `monde_libre_1993` | co.solvang.trahison_libre (year >= 1995, sinon variante `_clause`) |
...
| `international`, `capitaine`, `genou_opere` | co.legruet.congres_liste (pose `international`) ; co.malbec.lettres_vingt_cinq (lit `capitaine`) ; fiches Berthomier, Malbec |
...
| 3 | `dossier_sorti` | {annee} : le dossier Massenet est sorti, avec les dates. {nom} a répondu avant, ou après. | co.meneche.trahison_dossier | ch. 20, ch. 30 (grand_deballage plus), ch. 15 (valises), ch. 90 (Fantôme consultant) |
| 4 | `dossier_enterre` | {annee} : Massenet a enterré un dossier sur {nom}. Il a gardé le reçu. | co.meneche.faveur_enterre | ch. 20 (La Plume : « ce que le Quotidien n'a pas écrit »), ch. 15 (Amsel), ch. 31 (mémoires 2025) |
| 5 | `cheque_non_date` | {annee} : Vaubourg a posé un chèque non daté devant {nom}. Josiane l'a daté. | co.aulard.trahison_cheque_non_date | ch. 30 (en_sms, en_placard plus), ch. 15 (bloc Vaubourg), ch. 20, ch. 90 (Nemesis) |
| 6 | `aulard_rappelle` | {annee} : « Je te vire souvent, je te rappelle toujours. » Vaubourg a rappelé {nom}. | co.aulard.faveur_rappel | ch. 30 (Porte de sortie, Carrefour), ch. 11 (en.aulard_rappelle ×2), ch. 13 |
...
| 11 | `nassir_retire` | {annee} : Almadis a retiré ses panneaux, par notification. Gégé en a gardé un. | co.nassir.trahison_notification | ch. 30 (en_placard, pr_pantin plus), ch. 11 (variante « encore »), ch. 20, ch. 12 |
| 12 | `nassir_sans_condition` | {annee} : une saison sans condition, offerte par Ilyas à {nom}. « C'est un club. » | co.nassir.faveur_un_club | ch. 12 (fenêtre), ch. 13, ch. 15 (tournoi du désert), ch. 30 (en_coupable plus) |
...
| 29 | `annonce_avant_toi` | {annee} : Berthomier a annoncé le départ de {nom} à la télé. {nom} regardait. | co.legruet.trahison_avant_toi | ch. 30 (sl_minuit, in_defiance plus), ch. 14, ch. 15, ch. 20 |
| 30 | `districts_legruet` | {annee} : Berthomier a donné ses districts à {nom}. Roux a transmis. | co.legruet.faveur_les_districts | ch. 15 (élection), ch. 30 (Battu au Congrès plus ; Carte Destin), co.roux.faveur_siege |
...
| 43 | `huis_clos` | {annee} : le district a fermé le stade trois matchs. Sans buvette. | co.roux.trahison_huis_clos | ch. 30 (pa_club_a_cote plus), ch. 13, ch. 20, ch. 15 |
...
| 2 | `cahier_rossard` | co.rossard.faveur_vingt_trois | ch. 14, co.rossard.planche_quatre_vingt_seize, § 5, ch. 01, ch. 20, ch. 30 |
...
| 43 | `lanceur_alerte` (trace ch. 15, posée ici aussi) | co.la_plume.copies_dix_huit_millions | ch. 15 (in.lanceur_alerte, in.valises), ch. 30 (in_raid, *La radiation* plus), ch. 20 |
...
| 109 | `match_refuse` (et `enveloppe_promise` ∃ § 5.2, posée à droite, côté amateur) | co.pichon.francs_arrange | ch. 10, co.roux.base_samedi, § 5, ch. 15, ch. 30, ch. 20 |
