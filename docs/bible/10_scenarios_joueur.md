...
**Programme** (relu après la conversion et la passe de mesure ; c'est la base qui fait foi, `content/postulats.yaml` § pepite) : **"0"** prendre 3, fenêtre [1,12], réserve 1 — jp.banc_hiver, jp.camille_bac, jp.premiere_une, jp.selection, jp.contrat_image, jp.brassard_test, co.mbako_rival, jp.vestiaire_porte, jp.conseils_gigi, jp.tifo (signature) · **"1"** prendre 2, fenêtre [1,9], réserve 1, reprise — jp.clause, jp.camille_bac, co.pharmacie, co.derby, jp.genou_parle, jp.exil_dore · **"2+"** prendre 4, fenêtre [1,12], réserve 2, reprise — jp.retour_usine, jp.brassard_20, jp.diplome_joueur, jp.banc_hiver, jp.clause, jp.pari, co.derby, co.pharmacie, jp.consultant, jp.memoires, jp.derniere_selection, jp.jubile (la porte de contenu de la fin `jubile`, ch. 30). Deux intrigues citées plus haut sont **abandonnées** et ne seront pas écrites : `jp.dembo_rival` (le coéquipier rival est tenu par co.mbako_rival ; Dembo n'a pas de visage dans characters.yaml) et `jp.coach_qui_te_veut` (le coach qui te veut est déjà dit par jp.banc_hiver — le coach qui ne te veut pas — et par jp.clause). `jp.genou_20` est rendue par `jp.genou_parle`, écrite sans borne d'âge.
